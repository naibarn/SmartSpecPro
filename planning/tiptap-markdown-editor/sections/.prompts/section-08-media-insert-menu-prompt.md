...
Generate content for section `section-08-media-insert-menu` (filename: `section-08-media-insert-menu.md`).
...
for `section-08-media-insert-menu` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-08-media-insert-menu.md`
