...
Generate content for section `section-01-tiptap-setup` (filename: `section-01-tiptap-setup.md`).
...
for `section-01-tiptap-setup` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-01-tiptap-setup.md`
