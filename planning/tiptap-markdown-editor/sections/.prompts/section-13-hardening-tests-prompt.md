...
Generate content for section `section-13-hardening-tests` (filename: `section-13-hardening-tests.md`).
...
for `section-13-hardening-tests` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-13-hardening-tests.md`
