...
Generate content for section `section-06-media-extensions` (filename: `section-06-media-extensions.md`).
...
for `section-06-media-extensions` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-06-media-extensions.md`
