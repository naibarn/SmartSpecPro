...
Generate content for section `section-07-media-node-views` (filename: `section-07-media-node-views.md`).
...
for `section-07-media-node-views` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-07-media-node-views.md`
