...
Generate content for section `section-05-slash-commands` (filename: `section-05-slash-commands.md`).
...
for `section-05-slash-commands` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-05-slash-commands.md`
