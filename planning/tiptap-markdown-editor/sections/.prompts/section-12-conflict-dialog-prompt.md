...
Generate content for section `section-12-conflict-dialog` (filename: `section-12-conflict-dialog.md`).
...
for `section-12-conflict-dialog` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-12-conflict-dialog.md`
