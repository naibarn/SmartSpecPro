...
Generate content for section `section-04-toolbar-modes` (filename: `section-04-toolbar-modes.md`).
...
for `section-04-toolbar-modes` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/tiptap-markdown-editor/sections/section-04-toolbar-modes.md`
