...
Generate content for section `section-03-cost-tracker` (filename: `section-03-cost-tracker.md`).
...
for `section-03-cost-tracker` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-03-cost-tracker.md`
