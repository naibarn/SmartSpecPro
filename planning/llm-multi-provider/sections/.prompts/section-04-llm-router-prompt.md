...
Generate content for section `section-04-llm-router` (filename: `section-04-llm-router.md`).
...
for `section-04-llm-router` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-04-llm-router.md`
