...
Generate content for section `section-11-admin-page` (filename: `section-11-admin-page.md`).
...
for `section-11-admin-page` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-11-admin-page.md`
