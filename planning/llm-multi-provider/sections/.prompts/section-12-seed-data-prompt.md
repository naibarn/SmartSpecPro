...
Generate content for section `section-12-seed-data` (filename: `section-12-seed-data.md`).
...
for `section-12-seed-data` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-12-seed-data.md`
