...
Generate content for section `section-06-llm-routes` (filename: `section-06-llm-routes.md`).
...
for `section-06-llm-routes` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-06-llm-routes.md`
