...
Generate content for section `section-02-provider-health` (filename: `section-02-provider-health.md`).
...
for `section-02-provider-health` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-02-provider-health.md`
