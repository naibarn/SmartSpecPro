...
Generate content for section `section-05-credit-service` (filename: `section-05-credit-service.md`).
...
for `section-05-credit-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/llm-multi-provider/sections/section-05-credit-service.md`
