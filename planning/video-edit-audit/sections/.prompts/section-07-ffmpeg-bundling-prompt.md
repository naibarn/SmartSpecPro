...
Generate content for section `section-07-ffmpeg-bundling` (filename: `section-07-ffmpeg-bundling.md`).
...
for `section-07-ffmpeg-bundling` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/video-edit-audit/sections/section-07-ffmpeg-bundling.md`
