...
Generate content for section `section-08-validation-security` (filename: `section-08-validation-security.md`).
...
for `section-08-validation-security` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/video-edit-audit/sections/section-08-validation-security.md`
