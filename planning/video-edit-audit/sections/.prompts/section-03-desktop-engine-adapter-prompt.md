...
Generate content for section `section-03-desktop-engine-adapter` (filename: `section-03-desktop-engine-adapter.md`).
...
for `section-03-desktop-engine-adapter` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/video-edit-audit/sections/section-03-desktop-engine-adapter.md`
