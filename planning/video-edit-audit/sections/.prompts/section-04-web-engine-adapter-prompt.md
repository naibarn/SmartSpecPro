...
Generate content for section `section-04-web-engine-adapter` (filename: `section-04-web-engine-adapter.md`).
...
for `section-04-web-engine-adapter` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/video-edit-audit/sections/section-04-web-engine-adapter.md`
