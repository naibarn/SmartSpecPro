...
Generate content for section `section-01-job-spec-types` (filename: `section-01-job-spec-types.md`).
...
for `section-01-job-spec-types` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/video-edit-audit/sections/section-01-job-spec-types.md`
