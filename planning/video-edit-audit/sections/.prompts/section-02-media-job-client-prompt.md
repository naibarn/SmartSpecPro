...
Generate content for section `section-02-media-job-client` (filename: `section-02-media-job-client.md`).
...
for `section-02-media-job-client` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/video-edit-audit/sections/section-02-media-job-client.md`
