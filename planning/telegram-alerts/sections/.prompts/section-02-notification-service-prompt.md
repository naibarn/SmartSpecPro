...
Generate content for section `section-02-notification-service` (filename: `section-02-notification-service.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/dev/projects/SmartSpecPro/planning/telegram-alerts/claude-plan.md` - Full implementation plan
2. `/home/dev/projects/SmartSpecPro/planning/telegram-alerts/claude-plan-tdd.md` - Test stubs for each section
3. `/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-notification-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-02-notification-service.md`
