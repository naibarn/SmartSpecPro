...
Generate content for section `section-07-admin-ui` (filename: `section-07-admin-ui.md`).
...
for `section-07-admin-ui` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-07-admin-ui.md`
