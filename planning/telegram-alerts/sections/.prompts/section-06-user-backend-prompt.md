...
Generate content for section `section-06-user-backend` (filename: `section-06-user-backend.md`).
...
for `section-06-user-backend` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-06-user-backend.md`
