...
Generate content for section `section-03-telegram-service` (filename: `section-03-telegram-service.md`).
...
for `section-03-telegram-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-03-telegram-service.md`
