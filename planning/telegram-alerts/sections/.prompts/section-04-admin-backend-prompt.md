...
Generate content for section `section-04-admin-backend` (filename: `section-04-admin-backend.md`).
...
for `section-04-admin-backend` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-04-admin-backend.md`
