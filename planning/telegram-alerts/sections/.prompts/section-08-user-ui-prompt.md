...
Generate content for section `section-08-user-ui` (filename: `section-08-user-ui.md`).
...
for `section-08-user-ui` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-08-user-ui.md`
