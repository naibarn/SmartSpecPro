...
Generate content for section `section-10-testing` (filename: `section-10-testing.md`).
...
for `section-10-testing` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/telegram-alerts/sections/section-10-testing.md`
