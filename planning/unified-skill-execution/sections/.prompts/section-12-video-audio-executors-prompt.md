...
- Target file: `/home/dev/.claude/plans/sections/section-12-video-audio-executors.md`
- Section id: `section-12-video-audio-executors`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-12-video-audio-executors.md`.
