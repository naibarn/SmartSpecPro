...
- Target file: `/home/dev/.claude/plans/sections/section-08-wire-team-room.md`
- Section id: `section-08-wire-team-room`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-08-wire-team-room.md`.
