...
- Target file: `/home/dev/.claude/plans/sections/section-06-unified-orchestrator.md`
- Section id: `section-06-unified-orchestrator`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-06-unified-orchestrator.md`.
