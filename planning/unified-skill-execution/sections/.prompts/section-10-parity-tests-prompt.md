...
- Target file: `/home/dev/.claude/plans/sections/section-10-parity-tests.md`
- Section id: `section-10-parity-tests`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-10-parity-tests.md`.
