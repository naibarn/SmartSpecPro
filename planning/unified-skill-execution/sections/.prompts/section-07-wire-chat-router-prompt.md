...
- Target file: `/home/dev/.claude/plans/sections/section-07-wire-chat-router.md`
- Section id: `section-07-wire-chat-router`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-07-wire-chat-router.md`.
