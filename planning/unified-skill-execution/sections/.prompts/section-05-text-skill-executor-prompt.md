...
- Target file: `/home/dev/.claude/plans/sections/section-05-text-skill-executor.md`
- Section id: `section-05-text-skill-executor`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-05-text-skill-executor.md`.
