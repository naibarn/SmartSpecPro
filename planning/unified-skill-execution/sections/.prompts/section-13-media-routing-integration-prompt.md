...
- Target file: `/home/dev/.claude/plans/sections/section-13-media-routing-integration.md`
- Section id: `section-13-media-routing-integration`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-13-media-routing-integration.md`.
