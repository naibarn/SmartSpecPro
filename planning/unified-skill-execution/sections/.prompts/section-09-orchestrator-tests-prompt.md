...
- Target file: `/home/dev/.claude/plans/sections/section-09-orchestrator-tests.md`
- Section id: `section-09-orchestrator-tests`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-09-orchestrator-tests.md`.
