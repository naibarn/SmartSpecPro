...
- Target file: `/home/dev/.claude/plans/sections/section-01-types-and-contract.md`
- Section id: `section-01-types-and-contract`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-01-types-and-contract.md`.
