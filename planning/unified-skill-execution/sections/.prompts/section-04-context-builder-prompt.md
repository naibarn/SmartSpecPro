...
- Target file: `/home/dev/.claude/plans/sections/section-04-context-builder.md`
- Section id: `section-04-context-builder`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-04-context-builder.md`.
