...
- Target file: `/home/dev/.claude/plans/sections/section-02-executor-registry.md`
- Section id: `section-02-executor-registry`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/.claude/plans/sections/section-02-executor-registry.md`.
