...
Generate content for section `section-14-editor-refactor` (filename: `section-14-editor-refactor.md`).
...
for `section-14-editor-refactor` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-14-editor-refactor.md`
