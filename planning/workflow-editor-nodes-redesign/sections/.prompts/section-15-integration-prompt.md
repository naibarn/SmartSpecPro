...
Generate content for section `section-15-integration` (filename: `section-15-integration.md`).
...
for `section-15-integration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-15-integration.md`
