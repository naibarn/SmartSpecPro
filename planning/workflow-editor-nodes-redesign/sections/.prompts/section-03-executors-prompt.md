...
Generate content for section `section-03-executors` (filename: `section-03-executors.md`).
...
for `section-03-executors` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-03-executors.md`
