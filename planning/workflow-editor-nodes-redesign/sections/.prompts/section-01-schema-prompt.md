...
Generate content for section `section-01-schema` (filename: `section-01-schema.md`).
...
for `section-01-schema` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-01-schema.md`
