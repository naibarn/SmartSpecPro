...
Generate content for section `section-05-skill-nodes` (filename: `section-05-skill-nodes.md`).
...
for `section-05-skill-nodes` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-05-skill-nodes.md`
