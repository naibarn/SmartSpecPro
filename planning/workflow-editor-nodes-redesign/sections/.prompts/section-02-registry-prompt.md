...
Generate content for section `section-02-registry` (filename: `section-02-registry.md`).
...
for `section-02-registry` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-02-registry.md`
