...
Generate content for section `section-12-execution-viz` (filename: `section-12-execution-viz.md`).
...
for `section-12-execution-viz` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-12-execution-viz.md`
