...
Generate content for section `section-10-basenode` (filename: `section-10-basenode.md`).
...
for `section-10-basenode` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-10-basenode.md`
