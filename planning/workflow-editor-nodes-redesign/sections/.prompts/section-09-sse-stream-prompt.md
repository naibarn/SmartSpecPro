...
Generate content for section `section-09-sse-stream` (filename: `section-09-sse-stream.md`).
...
for `section-09-sse-stream` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-09-sse-stream.md`
