...
Generate content for section `section-13-template-browser` (filename: `section-13-template-browser.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/claude-plan.md` - Full implementation plan
2. `/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/claude-plan-tdd.md` - Test stubs for each section
3. `/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-13-template-browser` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-13-template-browser.md`
