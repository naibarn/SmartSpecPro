...
Generate content for section `section-07-compiler` (filename: `section-07-compiler.md`).
...
for `section-07-compiler` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-07-compiler.md`
