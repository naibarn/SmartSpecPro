...
Generate content for section `section-08-workflow-api` (filename: `section-08-workflow-api.md`).
...
for `section-08-workflow-api` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-08-workflow-api.md`
