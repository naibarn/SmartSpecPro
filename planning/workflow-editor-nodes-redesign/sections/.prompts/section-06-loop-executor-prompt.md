...
Generate content for section `section-06-loop-executor` (filename: `section-06-loop-executor.md`).
...
for `section-06-loop-executor` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/workflow-editor-nodes-redesign/sections/section-06-loop-executor.md`
