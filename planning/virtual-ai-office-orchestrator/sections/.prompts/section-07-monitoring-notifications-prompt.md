...
Generate content for section `section-07-monitoring-notifications` (filename: `section-07-monitoring-notifications.md`).
...
for `section-07-monitoring-notifications` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-07-monitoring-notifications.md`
