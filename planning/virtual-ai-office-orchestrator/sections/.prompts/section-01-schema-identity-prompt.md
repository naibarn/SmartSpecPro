...
Generate content for section `section-01-schema-identity` (filename: `section-01-schema-identity.md`).
...
for `section-01-schema-identity` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-01-schema-identity.md`
