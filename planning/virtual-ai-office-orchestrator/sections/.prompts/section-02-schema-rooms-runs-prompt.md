...
Generate content for section `section-02-schema-rooms-runs` (filename: `section-02-schema-rooms-runs.md`).
...
for `section-02-schema-rooms-runs` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-02-schema-rooms-runs.md`
