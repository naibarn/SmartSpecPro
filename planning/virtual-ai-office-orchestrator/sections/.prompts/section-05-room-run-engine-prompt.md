...
Generate content for section `section-05-room-run-engine` (filename: `section-05-room-run-engine.md`).
...
for `section-05-room-run-engine` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-05-room-run-engine.md`
