...
Generate content for section `section-14-frontend-room-monitor` (filename: `section-14-frontend-room-monitor.md`).
...
for `section-14-frontend-room-monitor` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-14-frontend-room-monitor.md`
