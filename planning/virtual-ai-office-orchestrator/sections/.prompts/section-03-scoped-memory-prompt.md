...
Generate content for section `section-03-scoped-memory` (filename: `section-03-scoped-memory.md`).
...
for `section-03-scoped-memory` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-03-scoped-memory.md`
