...
Generate content for section `section-11-sse-streaming` (filename: `section-11-sse-streaming.md`).
...
for `section-11-sse-streaming` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-11-sse-streaming.md`
