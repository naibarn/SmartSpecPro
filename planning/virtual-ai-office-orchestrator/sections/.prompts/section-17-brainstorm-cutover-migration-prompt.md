...
Generate content for section `section-17-brainstorm-cutover-migration` (filename: `section-17-brainstorm-cutover-migration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/claude-plan.md` - Full implementation plan
2. `/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/claude-plan-tdd.md` - Test stubs for each section
3. `/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-17-brainstorm-cutover-migration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-17-brainstorm-cutover-migration.md`
