...
Generate content for section `section-13-frontend-team-builder` (filename: `section-13-frontend-team-builder.md`).
...
for `section-13-frontend-team-builder` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/planning/virtual-ai-office-orchestrator/sections/section-13-frontend-team-builder.md`
