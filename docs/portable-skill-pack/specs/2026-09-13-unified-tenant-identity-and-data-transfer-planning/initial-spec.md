...
The approved design is `../2026-09-13-unified-tenant-identity-and-data-transfer-design.md`. This brief extracts the implementation scope for planning; the approved design remains the source of product decisions.
