...
3. If no fresh row appears, inspect the monitoring collector, scheduler, or backend write path.
...
1. Separate duplicate symptom alerts from the likely first failure.
2. Assign an owner.
