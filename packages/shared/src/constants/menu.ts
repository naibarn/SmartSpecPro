...
export const defaultMenuItems: MenuItem[] = [
  ...
  { id: 'worker-jobs', label: 'Worker Jobs', labelTh: 'คิวงาน Worker', icon: 'Activity', path: '/worker-jobs', platforms: ['web', 'desktop'], group: 'main', sortOrder: 4.01 },
  ...
  { id: 'video-editor',  label: 'Video Editor',    labelTh: 'ตัดต่อวิดีโอ',   icon: 'Film',            path: '/video-editor',   platforms: ['web', 'desktop'], group: 'main', sortOrder: 8.5 },
  ...
  {
    id: "admin-ops",
    label: "Advanced Ops Panels",
    labelTh: "แผงวิเคราะห์เชิงลึก",
    icon: "Activity",
    path: "/admin/ops",
    platforms: ["web", "desktop"],
    roles: ["admin"],
  ...
  {
    id: "admin-queues-media",
    label: "Media Monitor",
    icon: "PlayCircle",
    path: "/admin/queues/media",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 21.7,
  ...
  {
    id: "admin-orchestration-logs",
    label: "Orchestration Logs",
    labelTh: "บันทึก Orchestrator",
    icon: "Workflow",
  ...
  {
    id: "admin-marketplace-capture",
    label: "Marketplace Capture Ops",
    labelTh: "ระบบเก็บข้อมูล Marketplace",
    icon: "Store",
    path: "/admin/marketplace-capture",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 21.95,
    requiresFeature: "MARKETPLACE_CAPTURE_ENABLED",
  },
  {
    id: "admin-agent-experience-preview",
    label: "Agent Experience Preview",
    labelTh: "ตัวอย่าง Agent Experience",
    icon: "Activity",
    path: "/admin/agent-experience-preview",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 21.97,
  ...
  },
  {
    ...
    label: "Docker Status",
    icon: "Activity",
    path: "https://docker.smartaihub.app",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 22,
  ...
  },
  {
    ...
    icon: "Bug",
    path: "https://glitchtip.smartaihub.app",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 22.5,
  ...
  {
    id: "admin-media-models",
    label: "Media AI Models",
    icon: "Sparkles",
  ...
  {
    id: "admin-skill-revenue",
    label: "Skill Revenue",
    labelTh: "รายได้จาก Skill",
    icon: "Coins",
    path: "/admin/skill-revenue",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 28.5,
  ...
  {
    id: "admin-skill-repos",
    label: "Skill Repos",
    icon: "GitBranch",
    path: "/admin/skill-repositories",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 29,
  ...
  {
    id: "admin-channel-router",
    label: "Channel Router",
    labelTh: "ตัวกำหนดเส้นทาง",
    icon: "GitFork",
    path: "/admin/channel-router",
    platforms: ["web", "desktop"],
    roles: ["admin", "domain_admin"],
    group: "admin",
    sortOrder: 30.2,
    requiresFeature: "channelRouter",
  },
  {
    id: "admin-guardian",
    label: "System Guardian",
    labelTh: "ผู้พิทักษ์ระบบ",
    icon: "ShieldCheck",
    path: "/admin/system-guardian",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 19,
    requiresFeature: "VIRTUAL_ADMIN_ENABLED",
  },
  {
    id: "admin-monitoring",
    label: "Server Monitoring",
    labelTh: "ตรวจสอบ Server",
    icon: "Activity",
  ...
  {
    id: "admin-capacity-advisor",
    label: "Capacity Advisor",
    labelTh: "ประเมินขนาดระบบ",
    icon: "Gauge",
    path: "/admin/capacity-advisor",
    platforms: ["web", "desktop"],
    roles: ["admin"],
    group: "admin",
    sortOrder: 19.35,
  ...
  {
    id: "admin-content-quality",
    label: "Content Quality",
    labelTh: "คุณภาพเนื้อหา",
    icon: "ShieldCheck",
  ...
  {
    id: "desktop-host-governance",
    label: "Desktop Governance",
    labelTh: "กำกับดูแลเดสก์ท็อป",
    icon: "ShieldCheck",
    path: "/admin/desktop-host/governance",
    platforms: ["web", "desktop"],
    roles: ["admin", "domain_admin"],
    group: "admin",
    sortOrder: 31.8,
  ...
  {
    id: "admin-database-backups",
    label: "Database Backups",
    labelTh: "สำรองฐานข้อมูล",
    icon: "Download",
