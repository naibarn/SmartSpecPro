...
export const defaultMenuItems: MenuItem[] = [
  ...
  { id: 'vertical-drama-series', label: 'Vertical Drama Series', labelTh: 'ซีรีย์แนวตั้ง', icon: 'Clapperboard', path: '/drama-series', platforms: ['web', 'desktop'], group: 'main', sortOrder: 2.15, requiresFeature: 'verticalDramaSeriesDashboardMenu' },
