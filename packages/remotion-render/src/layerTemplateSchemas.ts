 ...
 *
 * `apps/web/shared/remotion/layerTemplateSchemas.ts` now re-exports
 * everything from this module for backward compatibility with existing
 * importers (`remotionTemplateService.ts`, tests, etc.).
 */
import { z } from "zod";
