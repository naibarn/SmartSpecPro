  ...
  if (inline) {
    return (
      <section
        ...
        className={cn(
          "bg-background relative grid w-full gap-4 rounded-lg border p-6 shadow-sm",
          className,
        )}
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        <DialogPrimitive.Content
          data-slot="dialog-content"
          className={cn(
            "bg-background pointer-events-auto relative z-50 grid w-full max-w-[calc(100%-2rem)] gap-4 rounded-lg border p-6 shadow-lg sm:max-w-lg",
            fullscreen &&
              "h-dvh max-w-none rounded-none border-0 p-0 shadow-none sm:max-w-none",
            className,
          )}
