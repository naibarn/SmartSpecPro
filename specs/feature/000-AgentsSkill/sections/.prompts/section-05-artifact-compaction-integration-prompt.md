...
Generate content for section `section-05-artifact-compaction-integration` (filename: `section-05-artifact-compaction-integration.md`).
...
for `section-05-artifact-compaction-integration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/000-AgentsSkill/sections/section-05-artifact-compaction-integration.md`
