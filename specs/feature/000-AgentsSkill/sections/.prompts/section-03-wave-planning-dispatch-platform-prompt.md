...
Generate content for section `section-03-wave-planning-dispatch-platform` (filename: `section-03-wave-planning-dispatch-platform.md`).
...
for `section-03-wave-planning-dispatch-platform` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/000-AgentsSkill/sections/section-03-wave-planning-dispatch-platform.md`
