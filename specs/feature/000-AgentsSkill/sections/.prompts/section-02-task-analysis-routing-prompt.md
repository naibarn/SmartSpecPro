...
Generate content for section `section-02-task-analysis-routing` (filename: `section-02-task-analysis-routing.md`).
...
for `section-02-task-analysis-routing` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/000-AgentsSkill/sections/section-02-task-analysis-routing.md`
