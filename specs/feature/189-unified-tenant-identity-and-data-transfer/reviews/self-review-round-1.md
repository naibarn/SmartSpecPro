...
7. **UI/API artifacts had implementation ambiguity.** Fixed by selecting `TenantDataTransfer.tsx`, `components/tenant-transfer/`, `tenantDataTransfer` router procedures, and the serialized migrations `0316_feature_189_tenant_identity_and_data_transfer.sql` plus `0317_feature_189_tenant_identity_backfill_completion.sql`.
