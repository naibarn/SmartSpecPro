...
Generate content for section `section-02-groups-service` (filename: `section-02-groups-service.md`).
...
for `section-02-groups-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/009-sharefile/sections/section-02-groups-service.md`
