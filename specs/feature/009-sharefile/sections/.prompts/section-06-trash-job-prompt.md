...
Generate content for section `section-06-trash-job` (filename: `section-06-trash-job.md`).
...
for `section-06-trash-job` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/009-sharefile/sections/section-06-trash-job.md`
