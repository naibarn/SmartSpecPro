...
Generate content for section `section-11-security-tests` (filename: `section-11-security-tests.md`).
...
for `section-11-security-tests` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/009-sharefile/sections/section-11-security-tests.md`
