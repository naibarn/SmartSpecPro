...
Generate content for section `section-09-trash-ui` (filename: `section-09-trash-ui.md`).
...
for `section-09-trash-ui` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/009-sharefile/sections/section-09-trash-ui.md`
