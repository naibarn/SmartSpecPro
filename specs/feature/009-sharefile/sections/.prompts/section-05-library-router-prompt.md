...
Generate content for section `section-05-library-router` (filename: `section-05-library-router.md`).
...
for `section-05-library-router` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/009-sharefile/sections/section-05-library-router.md`
