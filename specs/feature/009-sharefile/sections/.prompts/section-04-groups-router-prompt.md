...
Generate content for section `section-04-groups-router` (filename: `section-04-groups-router.md`).
...
for `section-04-groups-router` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/009-sharefile/sections/section-04-groups-router.md`
