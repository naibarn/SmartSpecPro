diff --git a/apps/web/server/services/securityShareFile.test.ts b/apps/web/server/services/securityShareFile.test.ts
new file mode 100644
index 0000000..fa12c0d
--- /dev/null
+++ b/apps/web/server/services/securityShareFile.test.ts
@@ -0,0 +1,500 @@
