...
Generate content for section `section-07-browser` (filename: `section-07-browser.md`).
...
for `section-07-browser` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-07-browser.md`
