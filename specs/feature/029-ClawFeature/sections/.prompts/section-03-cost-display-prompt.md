...
Generate content for section `section-03-cost-display` (filename: `section-03-cost-display.md`).
...
for `section-03-cost-display` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-03-cost-display.md`
