...
Generate content for section `section-12-channel-router` (filename: `section-12-channel-router.md`).
...
for `section-12-channel-router` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-12-channel-router.md`
