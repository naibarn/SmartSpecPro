...
Generate content for section `section-01-database` (filename: `section-01-database.md`).
...
for `section-01-database` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-01-database.md`
