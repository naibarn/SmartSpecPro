...
Generate content for section `section-06-voice` (filename: `section-06-voice.md`).
...
for `section-06-voice` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-06-voice.md`
