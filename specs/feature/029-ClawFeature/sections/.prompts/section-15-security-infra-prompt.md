...
Generate content for section `section-15-security-infra` (filename: `section-15-security-infra.md`).
...
for `section-15-security-infra` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-15-security-infra.md`
