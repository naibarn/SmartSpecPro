...
Generate content for section `section-11-webhooks` (filename: `section-11-webhooks.md`).
...
for `section-11-webhooks` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-11-webhooks.md`
