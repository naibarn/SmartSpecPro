...
Generate content for section `section-02-persona` (filename: `section-02-persona.md`).
...
for `section-02-persona` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/029-ClawFeature/sections/section-02-persona.md`
