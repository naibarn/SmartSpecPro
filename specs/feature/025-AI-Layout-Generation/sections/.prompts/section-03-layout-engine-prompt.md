...
Generate content for section `section-03-layout-engine` (filename: `section-03-layout-engine.md`).
...
for `section-03-layout-engine` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/025-AI-Layout-Generation/sections/section-03-layout-engine.md`
