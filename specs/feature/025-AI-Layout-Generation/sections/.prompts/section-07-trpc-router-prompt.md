...
Generate content for section `section-07-trpc-router` (filename: `section-07-trpc-router.md`).
...
for `section-07-trpc-router` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/025-AI-Layout-Generation/sections/section-07-trpc-router.md`
