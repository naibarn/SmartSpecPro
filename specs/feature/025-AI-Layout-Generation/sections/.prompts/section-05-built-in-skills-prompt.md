...
Generate content for section `section-05-built-in-skills` (filename: `section-05-built-in-skills.md`).
...
for `section-05-built-in-skills` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/025-AI-Layout-Generation/sections/section-05-built-in-skills.md`
