diff --git a/apps/web/drizzle/0067_confused_bastion.sql b/apps/web/drizzle/0067_confused_bastion.sql
new file mode 100644
index 00000000..5eb7607d
--- /dev/null
+++ b/apps/web/drizzle/0067_confused_bastion.sql
@@ -0,0 +1,31 @@
...
diff --git a/apps/web/drizzle/meta/0067_snapshot.json b/apps/web/drizzle/meta/0067_snapshot.json
new file mode 100644
index 00000000..b6ac386a
--- /dev/null
+++ b/apps/web/drizzle/meta/0067_snapshot.json
@@ -0,0 +1,20013 @@
+{
+  "id": "0e0b2bbb-fb9f-47f6-912a-d6943b8c7788",
+  "prevId": "7ae58e93-7b05-4cfb-b8eb-6568969afa8a",
+  "version": "7",
+  "dialect": "postgresql",
+  "tables": {
+    "public.agencies": {
...
index 6f1bb55e..49c18567 100644
--- a/apps/web/drizzle/meta/_journal.json
+++ b/apps/web/drizzle/meta/_journal.json
@@ -470,6 +470,13 @@
       "when": 1773221917737,
       "tag": "0066_fearless_spiral",
       "breakpoints": true
+    },
+    {
+      "idx": 67,
...
index e3041b27..9730bfc0 100644
...
index fc273989..75d91c29 100644
--- a/apps/web/server/_core/llmRoutes.ts
+++ b/apps/web/server/_core/llmRoutes.ts
@@ -2277,6 +2277,7 @@ Be comprehensive but avoid redundancy.`;
...
+          tenantId: (req as any).tenantId || "default",
           ...
           res,
@@ -2302,6 +2303,7 @@ Be comprehensive but avoid redundancy.`;
           model: req.body?.model,
           messages: req.body?.messages || [],
           userId: check.userId,
+          tenantId: (req as any).tenantId || "default",
...
index a4e74470..eac51c41 100644
...
index 380ec91f..d23a730d 100644
...
@@ -112,6 +127,20 @@ export const translationRouter = router({
...
diff --git a/apps/web/server/services/capabilityRegistry.ts b/apps/web/server/services/capabilityRegistry.ts
index 3922ed11..5c4c030e 100644
--- a/apps/web/server/services/capabilityRegistry.ts
+++ b/apps/web/server/services/capabilityRegistry.ts
@@ -104,6 +104,58 @@ export async function loadEnabledModelsWithCapabilities(): Promise<EnabledModelW
   }));
 }
...
index f72e65be..37063386 100644
...
@@ -522,6 +536,20 @@ async function processMessageServerSide(
...
index 6568a88d..c5d82e11 100644
...
+
   if (!effectiveModel) {
     ...
     return;
@@ -59,6 +77,21 @@ export async function handleChatWithRouter(params: HandlerParams): Promise<void>
         conversationId,
       });
...
@@ -145,6 +194,21 @@ export async function handleStreamWithRouter(params: HandlerParams): Promise<voi
         conversationId,
       });
...
index 752a9b53..ce323777 100644
...
+  }
   if (!model) {
     ...
     return;
@@ -309,6 +327,20 @@ export async function deliverScheduledMessage(scheduleId: number): Promise<void>
       },
     });
...
index 0298fcbd..456f34e9 100644
...
diff --git a/specs/feature/039-Planner-Runtime-Wiring/sections/index.md b/specs/feature/039-Planner-Runtime-Wiring/sections/index.md
new file mode 100644
index 00000000..2a12af9a
--- /dev/null
+++ b/specs/feature/039-Planner-Runtime-Wiring/sections/index.md
@@ -0,0 +1,28 @@
+<!-- PROJECT_CONFIG
+runtime: node-npm
