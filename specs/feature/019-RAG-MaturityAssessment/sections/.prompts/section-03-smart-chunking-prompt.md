...
Generate content for section `section-03-smart-chunking` (filename: `section-03-smart-chunking.md`).
...
for `section-03-smart-chunking` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/019-RAG-MaturityAssessment/sections/section-03-smart-chunking.md`
