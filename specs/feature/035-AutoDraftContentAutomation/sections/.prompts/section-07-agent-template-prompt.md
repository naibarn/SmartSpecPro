...
Generate content for section `section-07-agent-template` (filename: `section-07-agent-template.md`).
...
for `section-07-agent-template` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/035-AutoDraftContentAutomation/sections/section-07-agent-template.md`
