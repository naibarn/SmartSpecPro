...
Generate content for section `section-04-file-parse-tool` (filename: `section-04-file-parse-tool.md`).
...
for `section-04-file-parse-tool` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/035-AutoDraftContentAutomation/sections/section-04-file-parse-tool.md`
