...
Generate content for section `section-11-integration-tests` (filename: `section-11-integration-tests.md`).
...
for `section-11-integration-tests` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/035-AutoDraftContentAutomation/sections/section-11-integration-tests.md`
