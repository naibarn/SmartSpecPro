...
Generate content for section `section-15-security-hardening` (filename: `section-15-security-hardening.md`).
...
for `section-15-security-hardening` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/010-GoogleDriveScope/sections/section-15-security-hardening.md`
