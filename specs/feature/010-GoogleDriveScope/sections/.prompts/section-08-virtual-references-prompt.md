...
Generate content for section `section-08-virtual-references` (filename: `section-08-virtual-references.md`).
...
for `section-08-virtual-references` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/010-GoogleDriveScope/sections/section-08-virtual-references.md`
