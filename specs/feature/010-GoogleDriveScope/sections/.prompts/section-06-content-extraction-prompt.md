...
Generate content for section `section-06-content-extraction` (filename: `section-06-content-extraction.md`).
...
for `section-06-content-extraction` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/010-GoogleDriveScope/sections/section-06-content-extraction.md`
