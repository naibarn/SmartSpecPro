...
Generate content for section `section-01-admin-config` (filename: `section-01-admin-config.md`).
...
for `section-01-admin-config` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/010-GoogleDriveScope/sections/section-01-admin-config.md`
