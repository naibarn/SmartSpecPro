...
Generate content for section `section-11-sync-webhooks` (filename: `section-11-sync-webhooks.md`).
...
for `section-11-sync-webhooks` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/010-GoogleDriveScope/sections/section-11-sync-webhooks.md`
