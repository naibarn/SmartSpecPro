...
Generate content for section `section-03-oauth-consent` (filename: `section-03-oauth-consent.md`).
...
for `section-03-oauth-consent` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/010-GoogleDriveScope/sections/section-03-oauth-consent.md`
