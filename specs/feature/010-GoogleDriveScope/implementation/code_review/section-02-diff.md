diff --git a/apps/web/drizzle/0024_opposite_exiles.sql b/apps/web/drizzle/0024_opposite_exiles.sql
new file mode 100644
index 0000000..1a9a6c1
--- /dev/null
+++ b/apps/web/drizzle/0024_opposite_exiles.sql
@@ -0,0 +1,70 @@
...
+	"folder_selections" json DEFAULT '[]'::json,
+	"file_type_filter" json DEFAULT '[]'::json,
...
+);
+--> statement-breakpoint
+DROP INDEX "library_links_source_unique";--> statement-breakpoint
+ALTER TABLE "credit_transactions" ADD COLUMN "idempotency_key" varchar(256);--> statement-breakpoint
+ALTER TABLE "library_links" ADD COLUMN "tenant_id" varchar(36);--> statement-breakpoint
...
+CREATE UNIQUE INDEX "credit_transactions_idempotency_key_unique" ON "credit_transactions" USING btree ("idempotency_key") WHERE idempotency_key IS NOT NULL;--> statement-breakpoint
+CREATE UNIQUE INDEX "library_links_source_tenant_unique" ON "library_links" USING btree ("link_type","link_id","tenant_id");
\ No newline at end of file
diff --git a/apps/web/drizzle/meta/0024_snapshot.json b/apps/web/drizzle/meta/0024_snapshot.json
new file mode 100644
index 0000000..eb5deea
--- /dev/null
+++ b/apps/web/drizzle/meta/0024_snapshot.json
@@ -0,0 +1,10036 @@
+{
+  "id": "723f34ac-ac7d-4a7d-bd37-249665ebc90c",
+  "prevId": "69bf37e0-8b9d-4052-8cfe-7dd01a351718",
+  "version": "7",
+  "dialect": "postgresql",
+  "tables": {
...
@@ -160,7 +160,7 @@
       ...
       "version": "7",
       "when": 1770884293851,
-      "tag": "0022_motionless_william_stryker",
+      "tag": "0022_add_sharefile_schema",
       "breakpoints": true
     },
     {
@@ -169,6 +169,13 @@
       "when": 1771035125703,
       "tag": "0023_lean_vermin",
       "breakpoints": true
+    },
+    {
+      "idx": 24,
...
index c73fad6..8d60bf3 100644
--- a/apps/web/drizzle/schema.ts
+++ b/apps/web/drizzle/schema.ts
@@ -85,6 +85,22 @@ export const policyActionEnum = pgEnum("policy_action", [
   "require_approval",
 ]);
...
@@ -1637,6 +1661,90 @@ export const libraryIndexJobs = pgTable("library_index_jobs", {
...
diff --git a/apps/web/server/schema.googleDrive.test.ts b/apps/web/server/schema.googleDrive.test.ts
new file mode 100644
index 0000000..3fa1ed2
--- /dev/null
+++ b/apps/web/server/schema.googleDrive.test.ts
@@ -0,0 +1,93 @@
...
+  });
+});
diff --git a/python-backend/app/models/oauth.py b/python-backend/app/models/oauth.py
index ce26ebe..d0bdd88 100644
--- a/python-backend/app/models/oauth.py
+++ b/python-backend/app/models/oauth.py
@@ -2,7 +2,7 @@
...
@@ -23,14 +23,21 @@ class OAuthConnection(Base):
...
diff --git a/python-backend/migrations/004_oauth_drive_extensions.py b/python-backend/migrations/004_oauth_drive_extensions.py
new file mode 100644
index 0000000..209392d
--- /dev/null
+++ b/python-backend/migrations/004_oauth_drive_extensions.py
@@ -0,0 +1,107 @@
+"""
...
+    asyncio.run(upgrade())
diff --git a/python-backend/tests/test_oauth_migration.py b/python-backend/tests/test_oauth_migration.py
new file mode 100644
index 0000000..9ab3aba
--- /dev/null
+++ b/python-backend/tests/test_oauth_migration.py
@@ -0,0 +1,56 @@
+"""
...
+        )
diff --git a/specs/feature/010-GoogleDriveScope/implementation/deep_implement_config.json b/specs/feature/010-GoogleDriveScope/implementation/deep_implement_config.json
index 66bfb37..ff3583a 100644
--- a/specs/feature/010-GoogleDriveScope/implementation/deep_implement_config.json
+++ b/specs/feature/010-GoogleDriveScope/implementation/deep_implement_config.json
@@ -23,7 +23,12 @@
...
-  "created_at": "2026-02-14T07:17:19.444156+00:00"
+  "created_at": "2026-02-14T07:25:49.435272+00:00"
 }
\ No newline at end of file
