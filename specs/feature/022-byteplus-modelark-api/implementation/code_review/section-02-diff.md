diff --git a/apps/web/server/services/mediaGenerationService.test.ts b/apps/web/server/services/mediaGenerationService.test.ts
new file mode 100644
index 0000000..a7b2191
--- /dev/null
+++ b/apps/web/server/services/mediaGenerationService.test.ts
@@ -0,0 +1,85 @@
...
+  | "seedance-1-0-lite-i2v-250428";
 ...
 export type AudioModel =
   | "elevenlabs-tts"
@@ -123,6 +131,66 @@ export const MEDIA_MODELS: Record<string, ModelMetadata> = {
...
+  },
   ...
   "elevenlabs-tts": {
     id: "elevenlabs-tts",
diff --git a/specs/feature/022-byteplus-modelark-api/sections/section-02-nodejs-media-models.md b/specs/feature/022-byteplus-modelark-api/sections/section-02-nodejs-media-models.md
new file mode 100644
index 0000000..5b106a9
--- /dev/null
+++ b/specs/feature/022-byteplus-modelark-api/sections/section-02-nodejs-media-models.md
@@ -0,0 +1,258 @@
...
+
+**File to modify:** `/home/dev/projects/SmartSpecPro/apps/web/server/services/mediaGenerationService.ts`
+
+**Test command:** `cd apps/web && pnpm check && pnpm test`
+
+---
+
+## Background
