...
+
         if not self.unified_client.kie_ai_client:
             # Try to initialize from SmartSpecWeb media_providers
             from app.services.media_provider_service import initialize_kie_ai_client
diff --git a/python-backend/tests/unit/llm_proxy/test_gateway_unified_byteplus.py b/python-backend/tests/unit/llm_proxy/test_gateway_unified_byteplus.py
new file mode 100644
index 0000000..6560186
--- /dev/null
+++ b/python-backend/tests/unit/llm_proxy/test_gateway_unified_byteplus.py
@@ -0,0 +1,275 @@
+"""
