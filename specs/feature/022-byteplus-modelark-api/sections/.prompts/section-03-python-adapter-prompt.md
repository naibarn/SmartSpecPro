...
Generate content for section `section-03-python-adapter` (filename: `section-03-python-adapter.md`).
...
for `section-03-python-adapter` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/022-byteplus-modelark-api/sections/section-03-python-adapter.md`
