...
Generate content for section `section-06-polling-integration` (filename: `section-06-polling-integration.md`).
...
for `section-06-polling-integration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/022-byteplus-modelark-api/sections/section-06-polling-integration.md`
