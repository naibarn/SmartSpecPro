...
Generate content for section `section-05-gateway-routing` (filename: `section-05-gateway-routing.md`).
...
for `section-05-gateway-routing` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/022-byteplus-modelark-api/sections/section-05-gateway-routing.md`
