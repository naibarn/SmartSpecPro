...
Generate content for section `section-02-nodejs-media-models` (filename: `section-02-nodejs-media-models.md`).
...
for `section-02-nodejs-media-models` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/022-byteplus-modelark-api/sections/section-02-nodejs-media-models.md`
