...
Generate content for section `section-05-channel-gateway` (filename: `section-05-channel-gateway.md`).
...
for `section-05-channel-gateway` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/028-Chat-Bridge/sections/section-05-channel-gateway.md`
