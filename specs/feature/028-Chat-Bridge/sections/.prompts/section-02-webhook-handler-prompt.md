...
Generate content for section `section-02-webhook-handler` (filename: `section-02-webhook-handler.md`).
...
for `section-02-webhook-handler` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/028-Chat-Bridge/sections/section-02-webhook-handler.md`
