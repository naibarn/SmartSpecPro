...
Generate content for section `section-03-i18n-types` (filename: `section-03-i18n-types.md`).
...
for `section-03-i18n-types` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/028-Chat-Bridge/sections/section-03-i18n-types.md`
