...
Generate content for section `section-10-router-extensions` (filename: `section-10-router-extensions.md`).
...
for `section-10-router-extensions` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/028-Chat-Bridge/sections/section-10-router-extensions.md`
