...
Generate content for section `section-04-link-flow` (filename: `section-04-link-flow.md`).
...
for `section-04-link-flow` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/028-Chat-Bridge/sections/section-04-link-flow.md`
