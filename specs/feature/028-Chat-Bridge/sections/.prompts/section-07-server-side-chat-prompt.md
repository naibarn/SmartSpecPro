...
Generate content for section `section-07-server-side-chat` (filename: `section-07-server-side-chat.md`).
...
for `section-07-server-side-chat` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/028-Chat-Bridge/sections/section-07-server-side-chat.md`
