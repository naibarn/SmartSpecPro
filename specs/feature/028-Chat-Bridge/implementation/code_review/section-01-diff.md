diff --git a/apps/web/drizzle/0043_hot_hellcat.sql b/apps/web/drizzle/0043_hot_hellcat.sql
new file mode 100644
index 0000000..2e87516
--- /dev/null
+++ b/apps/web/drizzle/0043_hot_hellcat.sql
@@ -0,0 +1,112 @@
...
diff --git a/apps/web/drizzle/meta/0043_snapshot.json b/apps/web/drizzle/meta/0043_snapshot.json
new file mode 100644
index 0000000..edcfbc5
--- /dev/null
+++ b/apps/web/drizzle/meta/0043_snapshot.json
@@ -0,0 +1,15656 @@
+{
+  "id": "51422ba8-a30e-453b-badb-bafc6ad6abb9",
+  "prevId": "0b47f5c2-77cf-4bad-a332-55fe9b4c7eb9",
+  "version": "7",
+  "dialect": "postgresql",
+  "tables": {
+    "public.agencies": {
...
+          "onUpdate": "no action"
+        },
+        "agency_agent_tools_toolId_agency_tools_id_fk": {
+          "name": "agency_agent_tools_toolId_agency_tools_id_fk",
+          "tableFrom": "agency_agent_tools",
+          "tableTo": "agency_tools",
+          "columnsFrom": [
+            "toolId"
+          ],
+          "columnsTo": [
...
index d007ca1..8c01013 100644
--- a/apps/web/drizzle/meta/_journal.json
+++ b/apps/web/drizzle/meta/_journal.json
@@ -302,6 +302,13 @@
       "when": 1772181099675,
       "tag": "0042_quiet_jane_foster",
       "breakpoints": true
+    },
+    {
+      "idx": 43,
...
+import { integer, pgEnum, pgTable, text, timestamp, varchar, json, jsonb, boolean, numeric, serial, uniqueIndex, index, foreignKey, bigint, check, type AnyPgColumn } from "drizzle-orm/pg-core";
 ...
 /**
@@ -1160,6 +1160,9 @@ export const conversations = pgTable("conversations", {
...
@@ -1231,6 +1234,15 @@ export const messages = pgTable("messages", {
...
@@ -4032,3 +4044,158 @@ export const agencyConversations = pgTable("agency_conversations", {
...
diff --git a/apps/web/server/routers/__tests__/telegramBridge.schema.test.ts b/apps/web/server/routers/__tests__/telegramBridge.schema.test.ts
new file mode 100644
index 0000000..c668259
--- /dev/null
+++ b/apps/web/server/routers/__tests__/telegramBridge.schema.test.ts
@@ -0,0 +1,158 @@
...
index 5717740..90d9b7c 100644
--- a/python-backend/app/models/agency.py
...
diff --git a/python-backend/migrations/009_agency_messages_channel_columns.py b/python-backend/migrations/009_agency_messages_channel_columns.py
new file mode 100644
index 0000000..451ff78
--- /dev/null
+++ b/python-backend/migrations/009_agency_messages_channel_columns.py
@@ -0,0 +1,74 @@
+"""
...
+    asyncio.run(upgrade())
diff --git a/python-backend/tests/test_agency_messages_channel.py b/python-backend/tests/test_agency_messages_channel.py
new file mode 100644
index 0000000..89aeb1d
--- /dev/null
+++ b/python-backend/tests/test_agency_messages_channel.py
@@ -0,0 +1,93 @@
+"""
