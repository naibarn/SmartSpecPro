...
Generate content for section `section-08-export-dialog` (filename: `section-08-export-dialog.md`).
...
for `section-08-export-dialog` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-08-export-dialog.md`
