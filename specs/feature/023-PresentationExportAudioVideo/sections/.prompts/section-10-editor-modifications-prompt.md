...
Generate content for section `section-10-editor-modifications` (filename: `section-10-editor-modifications.md`).
...
for `section-10-editor-modifications` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-10-editor-modifications.md`
