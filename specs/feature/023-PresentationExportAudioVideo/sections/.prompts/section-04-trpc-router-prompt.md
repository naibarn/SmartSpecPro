...
Generate content for section `section-04-trpc-router` (filename: `section-04-trpc-router.md`).
...
for `section-04-trpc-router` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-04-trpc-router.md`
