...
Generate content for section `section-09-slide-audio-panel` (filename: `section-09-slide-audio-panel.md`).
...
for `section-09-slide-audio-panel` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-09-slide-audio-panel.md`
