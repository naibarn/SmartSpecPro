...
Generate content for section `section-02-shared-contracts` (filename: `section-02-shared-contracts.md`).
...
for `section-02-shared-contracts` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-02-shared-contracts.md`
