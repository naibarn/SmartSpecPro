...
Generate content for section `section-01-database-migration` (filename: `section-01-database-migration.md`).
...
for `section-01-database-migration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-01-database-migration.md`
