...
Generate content for section `section-11-play-mode-page` (filename: `section-11-play-mode-page.md`).
...
for `section-11-play-mode-page` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-11-play-mode-page.md`
