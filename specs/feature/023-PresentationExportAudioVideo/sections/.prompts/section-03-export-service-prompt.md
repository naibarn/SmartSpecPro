...
Generate content for section `section-03-export-service` (filename: `section-03-export-service.md`).
...
for `section-03-export-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-03-export-service.md`
