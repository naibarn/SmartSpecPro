...
Generate content for section `section-07-python-celery-task` (filename: `section-07-python-celery-task.md`).
...
for `section-07-python-celery-task` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/023-PresentationExportAudioVideo/sections/section-07-python-celery-task.md`
