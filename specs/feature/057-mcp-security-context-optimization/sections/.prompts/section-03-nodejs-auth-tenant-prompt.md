...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/057-mcp-security-context-optimization/sections/section-03-nodejs-auth-tenant.md`
- Section id: `section-03-nodejs-auth-tenant`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/057-mcp-security-context-optimization/sections/section-03-nodejs-auth-tenant.md`.
