...
Generate content for section `section-08-router-modifications` (filename: `section-08-router-modifications.md`).
...
for `section-08-router-modifications` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/026-OpenSandbox-integrate/sections/section-08-router-modifications.md`
