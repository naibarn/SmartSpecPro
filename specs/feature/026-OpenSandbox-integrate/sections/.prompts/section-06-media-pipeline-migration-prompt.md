...
Generate content for section `section-06-media-pipeline-migration` (filename: `section-06-media-pipeline-migration.md`).
...
for `section-06-media-pipeline-migration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/026-OpenSandbox-integrate/sections/section-06-media-pipeline-migration.md`
