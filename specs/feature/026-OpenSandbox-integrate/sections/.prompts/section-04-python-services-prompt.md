...
Generate content for section `section-04-python-services` (filename: `section-04-python-services.md`).
...
for `section-04-python-services` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/026-OpenSandbox-integrate/sections/section-04-python-services.md`
