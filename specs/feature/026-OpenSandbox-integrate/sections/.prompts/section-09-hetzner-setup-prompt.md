...
Generate content for section `section-09-hetzner-setup` (filename: `section-09-hetzner-setup.md`).
...
for `section-09-hetzner-setup` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/026-OpenSandbox-integrate/sections/section-09-hetzner-setup.md`
