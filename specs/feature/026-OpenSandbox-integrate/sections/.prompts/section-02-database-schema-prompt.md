...
Generate content for section `section-02-database-schema` (filename: `section-02-database-schema.md`).
...
for `section-02-database-schema` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/026-OpenSandbox-integrate/sections/section-02-database-schema.md`
