diff --git a/apps/web/drizzle/0065_cynical_darkhawk.sql b/apps/web/drizzle/0065_cynical_darkhawk.sql
new file mode 100644
index 00000000..7e306a21
--- /dev/null
+++ b/apps/web/drizzle/0065_cynical_darkhawk.sql
@@ -0,0 +1,5 @@
...
diff --git a/apps/web/drizzle/meta/0065_snapshot.json b/apps/web/drizzle/meta/0065_snapshot.json
new file mode 100644
index 00000000..c1b09996
--- /dev/null
+++ b/apps/web/drizzle/meta/0065_snapshot.json
@@ -0,0 +1,19618 @@
+{
+  "id": "44fb4efb-2c38-464a-bee1-92bc69fbb934",
+  "prevId": "e791a22c-d871-482d-b405-00c7f35ad3e3",
+  "version": "7",
+  "dialect": "postgresql",
+  "tables": {
+    "public.agencies": {
...
index 1080073d..c7bc6e4e 100644
--- a/apps/web/drizzle/meta/_journal.json
+++ b/apps/web/drizzle/meta/_journal.json
@@ -456,6 +456,13 @@
       "when": 1773214830891,
       "tag": "0064_typical_dracula",
       "breakpoints": true
+    },
+    {
+      "idx": 65,
...
index 58a90015..6fafa03c 100644
...
diff --git a/apps/web/server/services/artifactRouter.test.ts b/apps/web/server/services/artifactRouter.test.ts
new file mode 100644
index 00000000..dc9dd664
--- /dev/null
+++ b/apps/web/server/services/artifactRouter.test.ts
@@ -0,0 +1,131 @@
...
+  });
+});
diff --git a/apps/web/server/services/artifactRouter.ts b/apps/web/server/services/artifactRouter.ts
new file mode 100644
index 00000000..bbd60444
--- /dev/null
+++ b/apps/web/server/services/artifactRouter.ts
@@ -0,0 +1,95 @@
+/**
+ * Artifact Router
+ *
...
@@ -39,6 +43,9 @@ export async function createTaskRun(input: CreateTaskRunInput): Promise<{ id: nu
       planJson: input.plan,
...
@@ -168,6 +175,22 @@ export async function loadValidatedPlan(
...
+  if (artifact.presentationDeckId) updates.presentationDeckId = artifact.presentationDeckId;
+  if (artifact.artifactMessageId) updates.artifactMessageId = artifact.artifactMessageId;
+
