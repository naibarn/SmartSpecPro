...
Generate content for section `section-09-r2-storage` (filename: `section-09-r2-storage.md`).
...
for `section-09-r2-storage` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-09-r2-storage.md`
