...
Generate content for section `section-11-video-pipeline` (filename: `section-11-video-pipeline.md`).
...
for `section-11-video-pipeline` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-11-video-pipeline.md`
