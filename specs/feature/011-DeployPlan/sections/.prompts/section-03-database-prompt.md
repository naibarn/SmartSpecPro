...
Generate content for section `section-03-database` (filename: `section-03-database.md`).
...
for `section-03-database` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-03-database.md`
