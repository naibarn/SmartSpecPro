...
Generate content for section `section-17-cicd` (filename: `section-17-cicd.md`).
...
for `section-17-cicd` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-17-cicd.md`
