...
Generate content for section `section-18-auth-hardening` (filename: `section-18-auth-hardening.md`).
...
for `section-18-auth-hardening` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-18-auth-hardening.md`
