...
Generate content for section `section-04-cloud-tasks` (filename: `section-04-cloud-tasks.md`).
...
for `section-04-cloud-tasks` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-04-cloud-tasks.md`
