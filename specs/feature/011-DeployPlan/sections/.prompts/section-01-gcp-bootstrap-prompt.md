...
Generate content for section `section-01-gcp-bootstrap` (filename: `section-01-gcp-bootstrap.md`).
...
for `section-01-gcp-bootstrap` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-01-gcp-bootstrap.md`
