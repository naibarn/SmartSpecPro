...
Generate content for section `section-14-posthog` (filename: `section-14-posthog.md`).
...
for `section-14-posthog` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-14-posthog.md`
