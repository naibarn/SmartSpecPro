...
Generate content for section `section-20-prod-hardening` (filename: `section-20-prod-hardening.md`).
...
for `section-20-prod-hardening` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-20-prod-hardening.md`
