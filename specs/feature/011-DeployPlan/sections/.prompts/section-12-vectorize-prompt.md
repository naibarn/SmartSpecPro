...
Generate content for section `section-12-vectorize` (filename: `section-12-vectorize.md`).
...
for `section-12-vectorize` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-12-vectorize.md`
