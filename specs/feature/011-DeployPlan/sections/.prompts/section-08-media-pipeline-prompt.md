...
Generate content for section `section-08-media-pipeline` (filename: `section-08-media-pipeline.md`).
...
for `section-08-media-pipeline` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-08-media-pipeline.md`
