...
Generate content for section `section-07-kie-integration` (filename: `section-07-kie-integration.md`).
...
for `section-07-kie-integration` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/011-DeployPlan/sections/section-07-kie-integration.md`
