...
@@ -263,19 +273,165 @@ async def poll_job(request: Request):
...
+]
 ...
 # Dependencies are managed via requirements.txt for now
 # This file is primarily for tool configuration
diff --git a/python-backend/tests/unit/api/test_media_pipeline.py b/python-backend/tests/unit/api/test_media_pipeline.py
new file mode 100644
index 0000000..a07dcf1
--- /dev/null
+++ b/python-backend/tests/unit/api/test_media_pipeline.py
@@ -0,0 +1,383 @@
...
+    MockTaskService.update_task_by_external_id.assert_awaited_once()
diff --git a/python-backend/uv.lock b/python-backend/uv.lock
index 549ab45..c826a12 100644
--- a/python-backend/uv.lock
+++ b/python-backend/uv.lock
@@ -2,7 +2,100 @@ version = 1
 revision = 3
