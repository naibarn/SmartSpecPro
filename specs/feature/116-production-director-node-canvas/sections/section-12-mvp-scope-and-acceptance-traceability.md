...
| Review/Edit results sync back | Section 11/15 | Import test: `ProductionDownstreamResultRecord` updates selected takes/timeline/product QA without overwriting locked configs. |
...
| MVP adapters are bounded | Section 13 | MVP adapter tests cover Image, Video, and basic TTS; full matrix coverage is a later release gate. |
...
- downstream result record import handles conflicts and stale verifier markers,
...
- migration/backfill/rollback/schema-version tests pass.
