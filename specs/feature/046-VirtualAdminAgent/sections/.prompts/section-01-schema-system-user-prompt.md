...
Generate content for section `section-01-schema-system-user` (filename: `section-01-schema-system-user.md`).
...
for `section-01-schema-system-user` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/046-VirtualAdminAgent/sections/section-01-schema-system-user.md`
