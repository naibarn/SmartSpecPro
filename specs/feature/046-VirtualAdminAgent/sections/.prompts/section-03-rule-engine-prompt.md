...
Generate content for section `section-03-rule-engine` (filename: `section-03-rule-engine.md`).
...
for `section-03-rule-engine` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/046-VirtualAdminAgent/sections/section-03-rule-engine.md`
