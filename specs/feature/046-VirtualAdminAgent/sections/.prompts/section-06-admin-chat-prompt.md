...
Generate content for section `section-06-admin-chat` (filename: `section-06-admin-chat.md`).
...
for `section-06-admin-chat` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/046-VirtualAdminAgent/sections/section-06-admin-chat.md`
