...
Generate content for section `section-01-schema-extension` (filename: `section-01-schema-extension.md`).
...
for `section-01-schema-extension` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/sections/section-01-schema-extension.md`
