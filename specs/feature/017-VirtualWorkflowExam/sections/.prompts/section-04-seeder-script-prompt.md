...
Generate content for section `section-04-seeder-script` (filename: `section-04-seeder-script.md`).
...
for `section-04-seeder-script` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/sections/section-04-seeder-script.md`
