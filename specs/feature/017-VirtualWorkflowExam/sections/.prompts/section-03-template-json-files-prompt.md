...
Generate content for section `section-03-template-json-files` (filename: `section-03-template-json-files.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/claude-plan.md` - Full implementation plan
2. `/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/claude-plan-tdd.md` - Test stubs for each section
3. `/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-template-json-files` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/sections/section-03-template-json-files.md`
