...
Generate content for section `section-06-gallery-frontend` (filename: `section-06-gallery-frontend.md`).
...
for `section-06-gallery-frontend` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/017-VirtualWorkflowExam/sections/section-06-gallery-frontend.md`
