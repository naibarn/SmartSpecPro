...
Generate content for section `section-05-browser-runner` (filename: `section-05-browser-runner.md`).
...
for `section-05-browser-runner` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/032-Browser-Automation-Copilot/sections/section-05-browser-runner.md`
