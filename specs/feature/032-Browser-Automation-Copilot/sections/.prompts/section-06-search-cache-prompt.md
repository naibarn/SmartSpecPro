...
Generate content for section `section-06-search-cache` (filename: `section-06-search-cache.md`).
...
for `section-06-search-cache` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/032-Browser-Automation-Copilot/sections/section-06-search-cache.md`
