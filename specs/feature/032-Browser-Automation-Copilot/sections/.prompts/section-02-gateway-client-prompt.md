...
Generate content for section `section-02-gateway-client` (filename: `section-02-gateway-client.md`).
...
for `section-02-gateway-client` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/032-Browser-Automation-Copilot/sections/section-02-gateway-client.md`
