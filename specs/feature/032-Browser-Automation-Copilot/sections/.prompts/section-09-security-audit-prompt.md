...
Generate content for section `section-09-security-audit` (filename: `section-09-security-audit.md`).
...
for `section-09-security-audit` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/032-Browser-Automation-Copilot/sections/section-09-security-audit.md`
