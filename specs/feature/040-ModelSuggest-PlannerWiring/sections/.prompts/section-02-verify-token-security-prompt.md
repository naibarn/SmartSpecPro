...
Generate content for section `section-02-verify-token-security` (filename: `section-02-verify-token-security.md`).
...
for `section-02-verify-token-security` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/040-ModelSuggest-PlannerWiring/sections/section-02-verify-token-security.md`
