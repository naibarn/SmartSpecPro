...
Generate content for section `section-12-admin-ui` (filename: `section-12-admin-ui.md`).
...
for `section-12-admin-ui` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-12-admin-ui.md`
