...
Generate content for section `section-02-api-key-service` (filename: `section-02-api-key-service.md`).
...
for `section-02-api-key-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-02-api-key-service.md`
