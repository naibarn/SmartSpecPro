...
Generate content for section `section-10-job-automation` (filename: `section-10-job-automation.md`).
...
for `section-10-job-automation` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-10-job-automation.md`
