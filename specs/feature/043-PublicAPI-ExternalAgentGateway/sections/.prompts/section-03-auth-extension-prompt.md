...
Generate content for section `section-03-auth-extension` (filename: `section-03-auth-extension.md`).
...
for `section-03-auth-extension` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-03-auth-extension.md`
