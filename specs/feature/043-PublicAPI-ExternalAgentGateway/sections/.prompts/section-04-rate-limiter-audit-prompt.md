...
Generate content for section `section-04-rate-limiter-audit` (filename: `section-04-rate-limiter-audit.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/claude-plan.md` - Full implementation plan
2. `/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/claude-plan-tdd.md` - Test stubs for each section
3. `/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-rate-limiter-audit` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-04-rate-limiter-audit.md`
