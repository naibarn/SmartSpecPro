...
Generate content for section `section-01-database-schema` (filename: `section-01-database-schema.md`).
...
for `section-01-database-schema` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-01-database-schema.md`
