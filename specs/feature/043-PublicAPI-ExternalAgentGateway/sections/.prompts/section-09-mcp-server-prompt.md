...
Generate content for section `section-09-mcp-server` (filename: `section-09-mcp-server.md`).
...
for `section-09-mcp-server` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/043-PublicAPI-ExternalAgentGateway/sections/section-09-mcp-server.md`
