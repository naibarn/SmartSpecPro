...
- Completed this round:
  ...
  - dedicated Dashboard governance panel for admin/domain-admin users when Desktop Host is enabled
  ...
  - enrolled-device posture cards with PoP, attestation provider/claims, broker posture, and last-seen visibility
  ...
  - isolated rich-document parser capability cards with bounded format coverage, extractor backend, render backend, office renderer, rendered-preview coverage, macro/media inspection posture, layout-analysis posture, multi-page posture, and complex-document posture
