...
Generate content for section `section-05-api-key-service` (filename: `section-05-api-key-service.md`).
...
for `section-05-api-key-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/048-auth-token-storage-hardening/sections/section-05-api-key-service.md`
