diff --git a/apps/web/client/src/components/admin/AdminWebhookManagement.tsx b/apps/web/client/src/components/admin/AdminWebhookManagement.tsx
new file mode 100644
index 00000000..da782834
--- /dev/null
+++ b/apps/web/client/src/components/admin/AdminWebhookManagement.tsx
@@ -0,0 +1,10 @@
+/**
...
+}
diff --git a/apps/web/client/src/components/settings/WebhookManagement.tsx b/apps/web/client/src/components/settings/WebhookManagement.tsx
new file mode 100644
index 00000000..f65cacef
--- /dev/null
+++ b/apps/web/client/src/components/settings/WebhookManagement.tsx
@@ -0,0 +1,468 @@
+/**
...
+  );
+}
diff --git a/apps/web/drizzle/0106_marvelous_puck.sql b/apps/web/drizzle/0106_marvelous_puck.sql
new file mode 100644
index 00000000..dd2d3876
--- /dev/null
+++ b/apps/web/drizzle/0106_marvelous_puck.sql
@@ -0,0 +1,21 @@
...
diff --git a/apps/web/drizzle/meta/0106_snapshot.json b/apps/web/drizzle/meta/0106_snapshot.json
new file mode 100644
index 00000000..a1865f79
--- /dev/null
+++ b/apps/web/drizzle/meta/0106_snapshot.json
@@ -0,0 +1,30014 @@
+{
+  "id": "5069ac56-11c9-46eb-986f-817f2f52f0dd",
+  "prevId": "bc7f5889-571c-440c-85c5-6d376ba4897f",
+  "version": "7",
+  "dialect": "postgresql",
+  "tables": {
+    "public.agencies": {
...
index 94fae968..010a40a0 100644
...
index ff72efe5..10d78410 100644
--- a/apps/web/drizzle/schema.ts
+++ b/apps/web/drizzle/schema.ts
@@ -3222,6 +3222,33 @@ export const alertRules = pgTable("alert_rules", {
...
index 585b6c7b..3120edca 100644
...
+} from "../services/notificationWebhookService";
 ...
 export async function initializeNotificationJobs(): Promise<void> {
   try {
@@ -31,6 +35,14 @@ export async function initializeNotificationJobs(): Promise<void> {
...
@@ -51,5 +63,13 @@ export async function shutdownNotificationJobs(): Promise<void> {
       e instanceof Error ? e.message : e
     );
   }
+  try {
...
index 802c8951..cb025362 100644
...
diff --git a/apps/web/server/routers/__tests__/notificationWebhooks.test.ts b/apps/web/server/routers/__tests__/notificationWebhooks.test.ts
new file mode 100644
index 00000000..7f775bb3
--- /dev/null
+++ b/apps/web/server/routers/__tests__/notificationWebhooks.test.ts
@@ -0,0 +1,136 @@
...
+  });
+});
diff --git a/apps/web/server/routers/notificationWebhooks.ts b/apps/web/server/routers/notificationWebhooks.ts
new file mode 100644
index 00000000..ec1f7c64
--- /dev/null
+++ b/apps/web/server/routers/notificationWebhooks.ts
@@ -0,0 +1,347 @@
+/**
...
+    }),
+});
diff --git a/apps/web/server/services/__tests__/notificationWebhookService.test.ts b/apps/web/server/services/__tests__/notificationWebhookService.test.ts
new file mode 100644
index 00000000..6660d94a
--- /dev/null
+++ b/apps/web/server/services/__tests__/notificationWebhookService.test.ts
@@ -0,0 +1,608 @@
...
diff --git a/apps/web/server/services/notificationWebhookService.ts b/apps/web/server/services/notificationWebhookService.ts
new file mode 100644
index 00000000..749c7357
--- /dev/null
+++ b/apps/web/server/services/notificationWebhookService.ts
@@ -0,0 +1,431 @@
+/**
