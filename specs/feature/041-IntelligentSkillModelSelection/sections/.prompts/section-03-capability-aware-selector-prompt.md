...
Generate content for section `section-03-capability-aware-selector` (filename: `section-03-capability-aware-selector.md`).
...
for `section-03-capability-aware-selector` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/041-IntelligentSkillModelSelection/sections/section-03-capability-aware-selector.md`
