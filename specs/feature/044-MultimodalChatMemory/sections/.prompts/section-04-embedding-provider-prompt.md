...
Generate content for section `section-04-embedding-provider` (filename: `section-04-embedding-provider.md`).
...
for `section-04-embedding-provider` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/044-MultimodalChatMemory/sections/section-04-embedding-provider.md`
