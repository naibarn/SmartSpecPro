...
Generate content for section `section-06-retrieval-and-reference-resolution` (filename: `section-06-retrieval-and-reference-resolution.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/dev/projects/SmartSpecPro/specs/feature/044-MultimodalChatMemory/claude-plan.md` - Full implementation plan
2. `/home/dev/projects/SmartSpecPro/specs/feature/044-MultimodalChatMemory/claude-plan-tdd.md` - Test stubs for each section
3. `/home/dev/projects/SmartSpecPro/specs/feature/044-MultimodalChatMemory/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-retrieval-and-reference-resolution` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/044-MultimodalChatMemory/sections/section-06-retrieval-and-reference-resolution.md`
