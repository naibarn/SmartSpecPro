...
Generate content for section `section-02-media-asset-service` (filename: `section-02-media-asset-service.md`).
...
for `section-02-media-asset-service` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/044-MultimodalChatMemory/sections/section-02-media-asset-service.md`
