...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/073-nvidia-nim-provider/sections/section-03-admin-catalog-and-mutation-safety.md`
- Section id: `section-03-admin-catalog-and-mutation-safety`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/073-nvidia-nim-provider/sections/section-03-admin-catalog-and-mutation-safety.md`.
