...
Generate content for section `section-04-region-list` (filename: `section-04-region-list.md`).
...
for `section-04-region-list` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/selence-dectection/sections/section-04-region-list.md`
