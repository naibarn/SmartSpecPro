...
Generate content for section `section-03-settings-detection` (filename: `section-03-settings-detection.md`).
...
for `section-03-settings-detection` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/selence-dectection/sections/section-03-settings-detection.md`
