# Feature 063 — Media Studio Content Composer & Publish Router
...
Feature 063 adds an **Article Composer** track to Media Studio. Instead of only generating images/video/audio and leaving users to manually handle content elsewhere, the new track provides a self-contained workflow:
