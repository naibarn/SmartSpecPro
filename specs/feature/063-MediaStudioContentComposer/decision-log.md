...
## Decision 6: Keep 063 scoped as a new feature track, not a rewrite of the current media studio

- Reason: The existing image/video/audio studio already has a large, stable flow and should not be destabilized.
- Outcome: The implementation plan should add a dedicated article-composer tab and leave the current generation tabs intact.
