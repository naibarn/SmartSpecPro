...
Generate content for section `section-08-result-merger` (filename: `section-08-result-merger.md`).
...
for `section-08-result-merger` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/045-HybridSkillOrchestrator/sections/section-08-result-merger.md`
