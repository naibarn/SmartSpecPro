...
Generate content for section `section-09-quality-gate` (filename: `section-09-quality-gate.md`).
...
for `section-09-quality-gate` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/045-HybridSkillOrchestrator/sections/section-09-quality-gate.md`
