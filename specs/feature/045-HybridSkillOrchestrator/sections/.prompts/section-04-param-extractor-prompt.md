...
Generate content for section `section-04-param-extractor` (filename: `section-04-param-extractor.md`).
...
for `section-04-param-extractor` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/045-HybridSkillOrchestrator/sections/section-04-param-extractor.md`
