...
Generate content for section `section-07-agent-loop` (filename: `section-07-agent-loop.md`).
...
for `section-07-agent-loop` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/045-HybridSkillOrchestrator/sections/section-07-agent-loop.md`
