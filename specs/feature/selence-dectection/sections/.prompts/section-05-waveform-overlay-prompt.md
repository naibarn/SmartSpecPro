...
Generate content for section `section-05-waveform-overlay` (filename: `section-05-waveform-overlay.md`).
...
for `section-05-waveform-overlay` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/selence-dectection/sections/section-05-waveform-overlay.md`
