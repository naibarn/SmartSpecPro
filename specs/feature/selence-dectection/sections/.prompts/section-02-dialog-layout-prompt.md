...
Generate content for section `section-02-dialog-layout` (filename: `section-02-dialog-layout.md`).
...
for `section-02-dialog-layout` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/selence-dectection/sections/section-02-dialog-layout.md`
