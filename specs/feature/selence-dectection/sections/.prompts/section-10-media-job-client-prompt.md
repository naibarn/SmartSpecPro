...
Generate content for section `section-10-media-job-client` (filename: `section-10-media-job-client.md`).
...
for `section-10-media-job-client` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/selence-dectection/sections/section-10-media-job-client.md`
