...
Generate content for section `section-09-backend-dead-air-cut` (filename: `section-09-backend-dead-air-cut.md`).
...
for `section-09-backend-dead-air-cut` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/selence-dectection/sections/section-09-backend-dead-air-cut.md`
