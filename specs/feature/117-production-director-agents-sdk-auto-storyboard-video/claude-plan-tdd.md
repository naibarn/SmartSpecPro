...
- Test prompt-injection text from marketplace data is treated as untrusted context.
...
- Test privacy, audio-rights, distribution-profile, and feedback-memory blockers are timeline-visible and sanitized.
