...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-01-contracts-and-policy-foundation.md`
- Section id: `section-01-contracts-and-policy-foundation`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-01-contracts-and-policy-foundation.md`.
