...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-06-tauri-adapter-and-device-storage.md`
- Section id: `section-06-tauri-adapter-and-device-storage`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-06-tauri-adapter-and-device-storage.md`.
