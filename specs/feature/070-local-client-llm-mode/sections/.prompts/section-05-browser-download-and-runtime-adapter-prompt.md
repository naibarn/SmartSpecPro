...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-05-browser-download-and-runtime-adapter.md`
- Section id: `section-05-browser-download-and-runtime-adapter`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-05-browser-download-and-runtime-adapter.md`.
