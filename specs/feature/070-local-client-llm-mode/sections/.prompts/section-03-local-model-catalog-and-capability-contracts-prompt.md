...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-03-local-model-catalog-and-capability-contracts.md`
- Section id: `section-03-local-model-catalog-and-capability-contracts`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/070-local-client-llm-mode/sections/section-03-local-model-catalog-and-capability-contracts.md`.
