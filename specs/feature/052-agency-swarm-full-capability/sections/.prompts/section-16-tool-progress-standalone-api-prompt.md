...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/052-agency-swarm-full-capability/sections/section-16-tool-progress-standalone-api.md`
- Section id: `section-16-tool-progress-standalone-api`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/052-agency-swarm-full-capability/sections/section-16-tool-progress-standalone-api.md`.
