...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/052-agency-swarm-full-capability/sections/section-02-custom-tools-backend.md`
- Section id: `section-02-custom-tools-backend`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/052-agency-swarm-full-capability/sections/section-02-custom-tools-backend.md`.
