...
- Target file: `/home/dev/projects/SmartSpecPro/specs/feature/052-agency-swarm-full-capability/sections/section-19-loop-retry-node.md`
- Section id: `section-19-loop-retry-node`
...
Preferred execution:
- If your host sub-agent can edit files directly, write the completed markdown to `/home/dev/projects/SmartSpecPro/specs/feature/052-agency-swarm-full-capability/sections/section-19-loop-retry-node.md`.
