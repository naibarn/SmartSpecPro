...
diff --git a/apps/web/client/src/components/LocaleToggle.tsx b/apps/web/client/src/components/LocaleToggle.tsx
index 5946e0a1..c05eb781 100644
--- a/apps/web/client/src/components/LocaleToggle.tsx
+++ b/apps/web/client/src/components/LocaleToggle.tsx
@@ -1,4 +1,5 @@
...
@@ -6,7 +7,11 @@ interface LocaleToggleProps {
 }
...
+  const visibleLocales = currentLang === "en" ? ["en"] : ["en", currentLang];
   ...
   return (
     <div
@@ -17,21 +22,21 @@ export function LocaleToggle({ className }: LocaleToggleProps) {
       role="group"
...
+  );
+}
diff --git a/apps/web/client/src/components/__tests__/LocaleToggle.i18n.test.tsx b/apps/web/client/src/components/__tests__/LocaleToggle.i18n.test.tsx
new file mode 100644
index 00000000..83395ec8
--- /dev/null
+++ b/apps/web/client/src/components/__tests__/LocaleToggle.i18n.test.tsx
@@ -0,0 +1,95 @@
+/**
