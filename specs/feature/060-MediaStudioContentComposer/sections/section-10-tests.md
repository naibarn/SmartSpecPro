...
These tests verify that the feature-060 additions do not break existing functionality. They go into new files with the suffix `.regression.test.ts` to make them identifiable in CI.
