...
Generate content for section `section-07-celery-tasks` (filename: `section-07-celery-tasks.md`).
...
for `section-07-celery-tasks` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/031-PlaywrightVision/sections/section-07-celery-tasks.md`
