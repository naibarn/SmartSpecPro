...
Generate content for section `section-02-browser-pool` (filename: `section-02-browser-pool.md`).
...
for `section-02-browser-pool` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/031-PlaywrightVision/sections/section-02-browser-pool.md`
