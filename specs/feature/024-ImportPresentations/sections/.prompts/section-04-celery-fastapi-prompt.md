...
Generate content for section `section-04-celery-fastapi` (filename: `section-04-celery-fastapi.md`).
...
for `section-04-celery-fastapi` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/024-ImportPresentations/sections/section-04-celery-fastapi.md`
