...
Generate content for section `section-02-pptx-importer` (filename: `section-02-pptx-importer.md`).
...
for `section-02-pptx-importer` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/024-ImportPresentations/sections/section-02-pptx-importer.md`
