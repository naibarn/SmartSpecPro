...
Generate content for section `section-06-service-callback` (filename: `section-06-service-callback.md`).
...
for `section-06-service-callback` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/024-ImportPresentations/sections/section-06-service-callback.md`
