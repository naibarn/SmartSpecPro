diff --git a/apps/web/drizzle/0037_silky_otto_octavius.sql b/apps/web/drizzle/0037_silky_otto_octavius.sql
new file mode 100644
index 0000000..872d6d9
--- /dev/null
+++ b/apps/web/drizzle/0037_silky_otto_octavius.sql
@@ -0,0 +1,11 @@
...
diff --git a/apps/web/drizzle/meta/0037_snapshot.json b/apps/web/drizzle/meta/0037_snapshot.json
new file mode 100644
index 0000000..d0d1b15
--- /dev/null
+++ b/apps/web/drizzle/meta/0037_snapshot.json
@@ -0,0 +1,13077 @@
+{
+  "id": "2c45058f-0af9-4dc2-a29b-2ac89cae3e74",
+  "prevId": "c803f323-835b-4a1c-85b4-c2a4e9f8c078",
+  "version": "7",
+  "dialect": "postgresql",
+  "tables": {
...
index 4994cc0..5965322 100644
--- a/apps/web/drizzle/meta/_journal.json
+++ b/apps/web/drizzle/meta/_journal.json
@@ -260,6 +260,13 @@
       "when": 1771855984106,
       "tag": "0036_nosy_timeslip",
       "breakpoints": true
+    },
+    {
+      "idx": 37,
...
@@ -80,6 +80,7 @@ export interface PresentationConversionDependencies {
...
@@ -195,6 +196,7 @@ const fallbackStateDependencies = {
...
index c6b5dba..3888912 100644
--- a/apps/web/server/services/presentationPersistence.ts
+++ b/apps/web/server/services/presentationPersistence.ts
@@ -100,6 +100,7 @@ export interface PresentationConversionIdempotencyLookupInput extends Presentati
...
@@ -136,7 +137,7 @@ export const presentationConversionStatusSchema = z.enum([
...
diff --git a/specs/feature/024-ImportPresentations/sections/section-01-db-migration.md b/specs/feature/024-ImportPresentations/sections/section-01-db-migration.md
new file mode 100644
index 0000000..7f79f0a
--- /dev/null
+++ b/specs/feature/024-ImportPresentations/sections/section-01-db-migration.md
@@ -0,0 +1,221 @@
