...
Generate content for section `section-09-frontend-builder` (filename: `section-09-frontend-builder.md`).
...
for `section-09-frontend-builder` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/027-AgencySwarm/sections/section-09-frontend-builder.md`
