...
Generate content for section `section-11-admin-observability` (filename: `section-11-admin-observability.md`).
...
for `section-11-admin-observability` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/027-AgencySwarm/sections/section-11-admin-observability.md`
