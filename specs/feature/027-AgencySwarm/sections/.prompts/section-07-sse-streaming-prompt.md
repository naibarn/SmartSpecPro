...
Generate content for section `section-07-sse-streaming` (filename: `section-07-sse-streaming.md`).
...
for `section-07-sse-streaming` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/027-AgencySwarm/sections/section-07-sse-streaming.md`
