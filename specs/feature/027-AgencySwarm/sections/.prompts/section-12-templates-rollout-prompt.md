...
Generate content for section `section-12-templates-rollout` (filename: `section-12-templates-rollout.md`).
...
for `section-12-templates-rollout` to understand what this section should contain.
...
`/home/dev/projects/SmartSpecPro/specs/feature/027-AgencySwarm/sections/section-12-templates-rollout.md`
