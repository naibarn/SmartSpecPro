...
- Minor-safety QA blockers are publish-safety warnings, not Storyboard Review handoff blockers, when reviewable image/frame evidence exists. They must remain visible as reason codes for user repair and must not mark the media as clean publish-ready.
