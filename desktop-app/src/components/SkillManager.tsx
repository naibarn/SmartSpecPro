...
import { SkillImportExport } from './SkillImportExport';
import { SkillSyncManager } from './SkillSyncManager';
import { skillService } from '../services/skillService';
import type { Skill, SkillCreate, SkillTemplate, SkillMode, SkillScope } from '../types/skill';
    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-950">
      ...
      <div className="px-6 py-4 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <SkillImportExport workspace={workspace} onImportComplete={loadData} />
          <SkillSyncManager workspace={workspace} onSyncComplete={loadData} />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-hidden">
        <AnimatePresence mode="wait">
                  ...
                  <div className="mb-6 space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                      {searchQuery && (
                        <button
                    ...
                    <div className="flex gap-3 flex-wrap">
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          value={filterMode}
                          onChange={(e) => setFilterMode(e.target.value as SkillMode | 'all')}
                          className="px-3 py-1.5 text-sm bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500"
                        >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          value={filterScope}
                          onChange={(e) => setFilterScope(e.target.value as SkillScope | 'all')}
                          className="px-3 py-1.5 text-sm bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500"
                        >
                      ...
                      {(searchQuery || filterMode !== 'all' || filterScope !== 'all') && (
                        <button
                          onClick={() => {
                            setSearchQuery('');
                            setFilterMode('all');
          ...
          {/* Quick Setup Tab - Keep existing */}
          {activeTab === 'setup' && skills.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-64 text-gray-500 dark:text-gray-400">
                  <svg className="w-16 h-16 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
