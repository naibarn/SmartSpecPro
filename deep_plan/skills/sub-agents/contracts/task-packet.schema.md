...
```
QUALITY GATE:
  - TypeScript must compile: cd /home/dev/projects/SmartSpecPro/apps/web && pnpm check
  - Unit tests must pass: cd /home/dev/projects/SmartSpecPro/apps/web && pnpm test
```
...
QUALITY GATE:
  - TypeScript must compile: cd /home/dev/projects/SmartSpecPro/apps/web && pnpm check
  - No lint errors: cd /home/dev/projects/SmartSpecPro/apps/web && pnpm format
```
...
QUALITY GATE:
  - TypeScript must compile: cd /home/dev/projects/SmartSpecPro/apps/web && pnpm check
  - Tests must pass: cd /home/dev/projects/SmartSpecPro/apps/web && pnpm test
```
