...
6. **Write design doc** — save to `docs/portable-skill-pack/specs/YYYY-MM-DD-<topic>-design.md` (commit only if the user explicitly asks)
7. **Spec review loop** — perform a focused Codex review of the spec directly; fix issues up to 3 iterations, then surface to the human
8. **User reviews written spec** — ask user to review the spec file before proceeding
9. **Transition to implementation** — transition to an available Codex planning skill such as deep-plan-quick/deep-plan when appropriate to create implementation plan
...
- Write the validated design (spec) to `docs/portable-skill-pack/specs/YYYY-MM-DD-<topic>-design.md`
...
1. Review the spec with Codex directly (see spec-document-reviewer-prompt.md as source guidance)
