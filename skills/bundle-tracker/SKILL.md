---
name: bundle-tracker
description: Track build bundle size and heavy dependency signals. Use when the user asks for bundle-tracker, /bundle, or the corresponding bundled tool.
---

# bundle-tracker

Codex wrapper for bundled tool `bundle-tracker.mjs`.

## Source

- Source: Local portable skill pack
- Commit: 7a022be3b34abfc00a09ad9c2bf82870b2cfe6e8
- Tool: `tools/bundle-tracker.mjs`
...
```bash
node ${CODEX_HOME:-$HOME/.codex}/skills/bundle-tracker/tools/bundle-tracker.mjs <target-or-arguments>
```
