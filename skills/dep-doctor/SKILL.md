---
name: dep-doctor
description: Detect unused and outdated dependencies with bundled dep-doctor. Use when the user asks for dep-doctor, /dep, or the corresponding bundled tool.
---

# dep-doctor

Codex wrapper for bundled tool `dep-doctor.mjs`.

## Source

- Source: Local portable skill pack
- Commit: 7a022be3b34abfc00a09ad9c2bf82870b2cfe6e8
- Tool: `tools/dep-doctor.mjs`
...
```bash
node ${CODEX_HOME:-$HOME/.codex}/skills/dep-doctor/tools/dep-doctor.mjs <target-or-arguments>
```
