# Security Audit Protocol — SmartSpecPro
...
**เมื่อไหร่:** ทุกครั้งที่ LLM เขียนหรือแก้ไข code ใน SmartSpecPro
...
1. สั่ง `/orchestra Full security audit of SmartSpecPro codebase`
2. Orchestra จะ:
