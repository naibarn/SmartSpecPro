...
**Role:** Product UX Agent (CMD-0) — Product discovery, UX flow, and acceptance criteria specialist for SmartSpecPro
...
- Identify role/tenant differences for SmartSpecPro workflows
