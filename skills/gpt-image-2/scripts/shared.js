...
export const DEFAULT_IMAGE_DIR = "gpt-image-2-output/image";
export const DEFAULT_PROMPT_DIR = "gpt-image-2-output/prompt";
...
export function buildBaseUrl() {
  ...
  if (baseUrl !== DEFAULT_BASE_URL && process.env.SKILLPACK_ALLOW_CUSTOM_OPENAI_BASE_URL !== "1") {
    throw new Error(
      "Refusing non-default OPENAI_BASE_URL without SKILLPACK_ALLOW_CUSTOM_OPENAI_BASE_URL=1. " +
        "Confirm the destination before sending prompts or images to a custom gateway."
    );
  }
  return baseUrl;
}
