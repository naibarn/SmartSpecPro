...
description: "FastAPI Security Auditor (CMD-6) — Read-only security specialist for the active codebase's Python FastAPI backend"
model: sonnet
...
source file `skills/sub-agents/agents/security-fastapi.md`.
