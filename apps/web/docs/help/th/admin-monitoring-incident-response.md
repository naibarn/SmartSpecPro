...
ถ้า tenant ของคุณใช้ external Claw workers ให้ถือว่าแผง **Claw Workers** ในหน้า **Admin Monitoring** เป็นจุดตรวจแรก ๆ ด้วย

ใช้แผงนี้เพื่อ:

- เช็กว่า worker ออนไลน์อยู่หรือไม่
- เปิดดู diagnostics ล่าสุดที่ถูก redacted แล้ว
- สั่ง drain, disable, resume หรือ revoke worker
- กด **Redact Legacy Data** หนึ่งครั้ง ถ้า environment นี้เคยมี worker records จาก build เก่า

ถ้า workflow ค้างเพราะรอ external worker ให้เช็กแผงนี้ก่อน อย่าเพิ่งสรุปว่าปัญหาอยู่ที่ workflow อย่างเดียว
