---
name: camera-photography-reference-storyboard
description: Camera And Photography Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for cameras, lenses, action cameras, instant cameras, tripods, gimbals, flashes, lighting kits, microphones for camera, camera bags, filters, memory accessories, mounts, and photography tools, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for กล้องและอุปกรณ์ถ่ายภาพ (cameras, lenses, action cameras, instant cameras, tripods, gimbals, flashes, lighting kits, microphones for camera, camera bags, filters, memory accessories, mounts, and photography tools).
...
auto_trigger: false
triggerPatterns:
  - Camera And Photography Reference Storyboard
...
This skill writes high-fidelity image and storyboard prompts for กล้องและอุปกรณ์ถ่ายภาพ (cameras, lenses, action cameras, instant cameras, tripods, gimbals, flashes, lighting kits, microphones for camera, camera bags, filters, memory accessories, mounts, and photography tools). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced camera or photography product.
...
For กล้องและอุปกรณ์ถ่ายภาพ, the prompt must additionally preserve:
- camera bodies: grip, viewfinder, hot shoe, mode dial, shutter button, screen, strap lug, mount
- lenses: barrel length, focus/zoom rings, front glass, filter thread, aperture marks, lens hood
- support gear: tripod leg sections, ball head, quick release plate, gimbal arms, clamps, mounts
- lighting: softbox shape, LED panel grid, flash head, stand, diffuser, power controls
- optics/materials: black textured body, rubber rings, glass reflection, metal mount, fabric bag weave

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve camera body shape, lens mount diameter, lens ring count, control dial positions, screen/viewfinder placement, tripod leg count/locks, gimbal arm layout, flash/LED panel geometry, and mount mechanisms.

### Material And Texture

Preserve matte camera texture, rubber grip, metal lens mount, coated glass reflections, knurled dials, anodized aluminum, nylon camera bag weave, and plastic/metal tripod finishes.

### Marking, Label, And Physical Text Preservation

Preserve lens focal length/aperture text, body model marks, dial icons, brand badges, filter size, and physical labels only if visible; never invent camera specs.

### Scale And Context

Show realistic hand, camera strap, desk, studio, tripod, lens cap, camera bag, or shooting setup scale; do not turn action cameras into DSLRs or lenses into generic tubes.

### Product Interaction And Use

Use scenes such as holding camera, lens mount, tripod setup, ring adjustment, screen angle, lighting setup, bag organization, filter close-up, or shooting context.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- inventing lens specs
- changing lens mount or ring count
- turning compact/action camera into DSLR
- removing tripod locks
- changing body controls
- fake brand/spec labels
...
Frame 2: hand scale.
Frame 3: front lens/body detail.
Frame 4: side/top controls.
Frame 5: mount or setup action.
Frame 6: glass/material macro.
Frame 7: bag/accessory layout.
Frame 8: shooting context.
Frame 9: final creator lifestyle scene.
...
The final prompt must make the image model preserve the real referenced camera or photography product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.