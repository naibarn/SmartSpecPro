...
Plain-text ElevenLabs-style product voiceover/dialogue generator for ecommerce product videos, demos, UGC ads, storyboard narration, and category-safe product audio. Beauty and personal-care claim guards still apply when those categories appear in the source details.

## Output

Final output is a customer-facing voiceover or dialogue string, not JSON, and not wrapped in Markdown code fences.
