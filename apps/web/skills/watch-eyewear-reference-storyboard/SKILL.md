---
name: watch-eyewear-reference-storyboard
description: Watch And Eyewear Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for watches, smart watches, watch straps, sunglasses, prescription frames, reading glasses, blue-light glasses, eyewear cases, watch boxes, and related accessories, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for นาฬิกาและแว่นตา (watches, smart watches, watch straps, sunglasses, prescription frames, reading glasses, blue-light glasses, eyewear cases, watch boxes, and related accessories).
...
auto_trigger: false
triggerPatterns:
  - Watch And Eyewear Reference Storyboard
...
This skill writes high-fidelity image and storyboard prompts for นาฬิกาและแว่นตา (watches, smart watches, watch straps, sunglasses, prescription frames, reading glasses, blue-light glasses, eyewear cases, watch boxes, and related accessories). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced watch or eyewear product.
...
For นาฬิกาและแว่นตา, the prompt must additionally preserve:
- watches: case shape, bezel, crown, pushers, dial markers, hands, subdials, strap, clasp, lugs
- smart watches: screen shape, bezel, side button, sensor back, strap attachment, UI only when requested
- eyewear: lens shape, bridge, nose pads, rim style, temple arms, hinges, end tips, lens tint
- materials: stainless steel, gold tone, ceramic, resin, acetate, TR90, titanium, leather, silicone
- presentation: wrist fit, face close-up, side hinge, case interior, lens transparency/reflection

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve dial or lens geometry, case/rim thickness, bridge width, temple angle, hinge shape, strap width, clasp, crown/pusher placement, marker count, lens tint, and left/right symmetry.

### Material And Texture

Preserve polished/brushed metal, leather grain, silicone matte finish, acetate translucency, lens transparency, coating reflections, ceramic gloss, and dial texture.

### Marking, Label, And Physical Text Preservation

Preserve dial brand, numerals, marker style, strap embossing, lens logo, frame inner-arm text, and case labels when visible; do not invent luxury branding.

### Scale And Context

Show realistic wrist, face, hand, case, table, outfit, or optical-shop scale; do not enlarge eyewear into goggles or shrink watches into bracelets.

### Product Interaction And Use

Use scenes such as wrist wear, face wear, case open, dial/lens close-up, side hinge/crown detail, strap/clasp adjustment, reflection test, or styling context.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing dial layout
- inventing subdials or numerals
- changing lens/frame shape
- turning glasses into goggles
- changing metal color
- adding fake luxury marks
...
Frame 2: worn scale frame.
Frame 3: front face/dial view.
Frame 4: side profile/temple or strap.
Frame 5: material close-up.
Frame 6: clasp/hinge/crown detail.
Frame 7: case/unboxing.
Frame 8: reflection/readability frame.
...
The final prompt must make the image model preserve the real referenced watch or eyewear product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.