# Editorial Layout Planner Skill

ชุด skill สำเร็จรูปสำหรับสร้าง **slide / page document** เชิงบรรณาธิการที่เน้นความอ่านง่ายและโครงสร้างแบบ layout spec จริง พร้อมเรนเดอร์เป็น **PPTX, PDF, JSON layout spec และ Markdown** จาก input ที่มี **ข้อความ + รูปภาพ 1-3 รูปต่อหน้า หรือ image pool กลางทั้งชุด** หรือข้อความยาวที่ต้องให้ระบบ **ซอยอัตโนมัติเป็นหลายหน้า** ตามความหนาแน่นของเนื้อหา
...
- รักษา mood แบบ editorial paper มากกว่าลุค modern report
