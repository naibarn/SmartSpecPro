---
name: stationery-reference-storyboard
description: Stationery Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for stationery and office supplies such as pens, pencils, markers, notebooks, planners, paper, sticky notes, folders, binders, art supplies, erasers, rulers, tapes, clips, desk organizers, and school supplies, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for เครื่องเขียน (stationery and office supplies such as pens, pencils, markers, notebooks, planners, paper, sticky notes, folders, binders, art supplies, erasers, rulers, tapes, clips, desk organizers, and school supplies).
...
This skill writes high-fidelity image and storyboard prompts for เครื่องเขียน (stationery and office supplies such as pens, pencils, markers, notebooks, planners, paper, sticky notes, folders, binders, art supplies, erasers, rulers, tapes, clips, desk organizers, and school supplies). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced stationery product.
...
For เครื่องเขียน, the prompt must additionally preserve:
- writing tools: pen barrel, cap, clip, tip, nib, refill, pencil lead, marker chisel tip, brush tip
- paper products: notebook binding, page ruling/grid/dot pattern, cover texture, spine, tabs, sticky note pad
- office tools: stapler, tape dispenser, scissors, clips, binder rings, folder pockets, ruler markings
- art supplies: paint tube, palette, colored pencil, crayon, brush bristles, ink bottle, paper texture
- desk organization: pen cup, tray, drawer organizer, file box, label tab, transparent pockets

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve pen/cap/tip geometry, notebook trim size, binding type, page line/grid pattern, folder flap, clip count, ruler scale, dispenser shape, brush bristle density, and organizer compartments.

### Material And Texture

Preserve paper fiber, matte/gloss cover, translucent plastic, metal clip, rubber grip, wood pencil grain, ink gloss, marker felt, brush hair texture, cardboard, and canvas pencil-case weave.

### Marking, Label, And Physical Text Preservation

Preserve printed ruled lines, ruler numbers, brand marks, color names, notebook cover text, tab labels, and packaging text when visible; do not invent notes or planner text.

### Scale And Context

Show realistic hand, desk, school bag, notebook, workspace, paper stack, or drawing surface scale; do not enlarge small tools into decor.

### Product Interaction And Use

Use scenes such as writing, drawing, opening notebook, cap on/off, page flip, organizing desk, art swatch, ruler measure, or pack/unboxing while preserving exact product.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing pen tip type
- inventing handwritten text
- changing page ruling
- removing binding or clips
- turning stationery into electronics
- fake brand labels
...
Frame 2: hand/desk scale.
Frame 3: tip or binding close-up.
Frame 4: material/page texture.
Frame 5: use action.
Frame 6: organization context.
Frame 7: pack/set layout.
Frame 8: marking/label detail.
Frame 9: final study/work lifestyle scene.
...
The final prompt must make the image model preserve the real referenced stationery product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.