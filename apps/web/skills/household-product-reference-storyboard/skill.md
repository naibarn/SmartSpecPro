---
name: household-product-reference-storyboard
description: Household Product Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for household goods, home-use items, cleaning tools, organizers, kitchenware, bathroom items, laundry tools, storage containers, bedding-adjacent utility items, and non-electric home accessories, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for เครื่องใช้ในบ้าน (household goods, home-use items, cleaning tools, organizers, kitchenware, bathroom items, laundry tools, storage containers, bedding-adjacent utility items, and non-electric home accessories).
...
This skill writes high-fidelity image and storyboard prompts for เครื่องใช้ในบ้าน (household goods, home-use items, cleaning tools, organizers, kitchenware, bathroom items, laundry tools, storage containers, bedding-adjacent utility items, and non-electric home accessories). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced household product.
...
For เครื่องใช้ในบ้าน, the prompt must additionally preserve:
- cleaning tools: mops, brooms, brushes, dusters, buckets, spray bottles, microfiber cloths
- home organization: storage boxes, bins, hangers, hooks, racks, drawer organizers, vacuum bags
- kitchen and dining utility: containers, lunch boxes, strainers, cutting boards, cups, trays, utensils
- bathroom and laundry: soap holders, toilet brushes, laundry baskets, drying racks, dispensers
- soft home goods: mats, towels, covers, liners, textile organizers, pillow/cushion utility covers

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve container geometry, lid/handle/clip/hinge shape, brush head density, mop pad thickness, pole length, nozzle angle, hook count, basket weave/opening pattern, edge radius, folding joints, and wall/floor contact. Keep thin flexible items thin and rigid molded items rigid.

### Material And Texture

Preserve plastic translucency, silicone softness, stainless steel shine, bamboo/wood grain, microfiber pile, woven basket texture, rubber grip, ceramic gloss, matte powder coating, and fabric stitch/edge binding.

### Marking, Label, And Physical Text Preservation

Preserve product labels, measurement marks, printed cleaning icons, molded logos, care tags, capacity marks, and packaging text when physically present; exclude ecommerce promo overlays.

### Scale And Context

Show realistic hand, sink, counter, cabinet, door, bathroom, laundry, or floor scale without resizing a small organizer into furniture or a thin mat into a rug/mattress.

### Product Interaction And Use

Use scenes such as filling, opening, hanging, stacking, wiping, washing, drying, storing, carrying, dispensing, or before/after organization while keeping the same product visible.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- turning a small household item into furniture
- making a manual tool electric
- changing plastic into glass/metal luxury redesign
- inflating thin textiles into thick bedding
- adding fake measurement labels or promotional callouts
...
Frame 1: hero product view.
Frame 2: size-in-hand or room placement.
Frame 3: open/closed or assembled state.
Frame 4: material close-up.
Frame 5: functional detail.
Frame 6: real use action.
Frame 7: storage/clean result.
Frame 8: edge/handle/lid detail.
Frame 9: final home lifestyle view.
...
The final prompt must make the image model preserve the real referenced household product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.