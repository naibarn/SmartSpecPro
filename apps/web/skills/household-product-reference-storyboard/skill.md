...
The final prompt must make the image model preserve the real referenced household product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype.