---
name: shoes-reference-storyboard
description: Shoes Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for footwear such as sneakers, running shoes, sandals, slippers, boots, heels, loafers, flats, kids shoes, sports shoes, safety shoes, and shoe accessories sold as the product, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for รองเท้า (footwear such as sneakers, running shoes, sandals, slippers, boots, heels, loafers, flats, kids shoes, sports shoes, safety shoes, and shoe accessories sold as the product).
...
This skill writes high-fidelity image and storyboard prompts for รองเท้า (footwear such as sneakers, running shoes, sandals, slippers, boots, heels, loafers, flats, kids shoes, sports shoes, safety shoes, and shoe accessories sold as the product). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced shoe or footwear product.
...
For รองเท้า, the prompt must additionally preserve:
- upper construction: toe box, vamp, quarter, heel counter, tongue, collar, strap, buckle
- sole system: outsole tread, midsole thickness, heel height, platform, air pocket, cleat, arch shape
- closures: laces, hook-loop straps, zippers, slip-on elastic, buckles, drawcords
- materials: mesh, knit, leather, suede, rubber, EVA foam, canvas, transparent PVC, woven strap
- pair details: left/right symmetry, logo placement, insole, stitching, eyelets, lace pattern, tread marks

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve toe shape, side profile, heel height, sole thickness, tread pattern, strap path, lace routing, tongue length, collar height, buckle/eyelet count, pair orientation, and size proportions.

### Material And Texture

Preserve leather grain, suede nap, mesh holes, knit weave, rubber matte finish, glossy patent surface, EVA foam texture, canvas weave, stitching relief, and outsole texture.

### Marking, Label, And Physical Text Preservation

Preserve logos on tongue, side, heel tab, insole, outsole, size tags, and printed pattern text; do not invent sneaker branding or sport badges.

### Scale And Context

Show realistic foot, hand, box, floor, outfit, sports court, street, or shelf scale; do not turn sandals into sneakers or low shoes into boots.

### Product Interaction And Use

Use scenes such as pair hero, side profile, worn on foot, sole tread close-up, lace/strap adjustment, walking/running, outfit context, box/unboxing, or material detail.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing toe box or heel height
- inventing sole technology
- removing laces/straps
- changing material from mesh to leather
- mixing left/right shoes incorrectly
- altering tread pattern
...
Frame 1: pair hero 3/4 view.
Frame 2: side profile.
Frame 3: top view.
Frame 4: sole tread close-up.
Frame 5: material/stitch detail.
Frame 6: worn fit frame.
Frame 7: closure action.
Frame 8: box/size context.
Frame 9: final lifestyle/walking scene.
...
The final prompt must make the image model preserve the real referenced shoe or footwear product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.