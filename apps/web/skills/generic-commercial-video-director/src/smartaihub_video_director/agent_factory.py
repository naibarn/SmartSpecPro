    ...
    def build(self, stage:str, *, model:str|None=None, allow_research_tool:bool=True,
        ...
        if stage == "observed_start_state":
            ...
            stage_policy = (
              ...
              "When canonical dialogue exists, preserve each input dialogue object's stable speaker ID and viewer-relative position together with its exact line; do not invent, translate, paraphrase, reorder, or transfer speech between characters. Describe natural speaking mouth movement and lip-sync only for that bound speaker. "
