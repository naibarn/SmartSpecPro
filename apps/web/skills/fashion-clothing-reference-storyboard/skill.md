---
name: fashion-clothing-reference-storyboard
description: Fashion Clothing Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for fashion garments including shirts, blouses, dresses, pants, skirts, jackets, coats, activewear, swimwear, uniforms, lingerie when appropriate, scarves, hats, and textile fashion sets, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for เสื้อผ้าแฟชั่น (fashion garments including shirts, blouses, dresses, pants, skirts, jackets, coats, activewear, swimwear, uniforms, lingerie when appropriate, scarves, hats, and textile fashion sets).
...
This skill writes high-fidelity image and storyboard prompts for เสื้อผ้าแฟชั่น (fashion garments including shirts, blouses, dresses, pants, skirts, jackets, coats, activewear, swimwear, uniforms, lingerie when appropriate, scarves, hats, and textile fashion sets). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced fashion clothing product.
...
For เสื้อผ้าแฟชั่น, the prompt must additionally preserve:
- tops: collar, neckline, sleeve length, cuff, placket, button count, pocket placement
- bottoms: waistband, rise, inseam, pocket shape, pleats, hem, zipper/fly, leg silhouette
- dresses and outerwear: bodice, skirt shape, lapel, closure, lining, belt, hood, seam panels
- fabric effects: drape, stretch, transparency, knit rib, denim twill, satin sheen, lace, embroidery
- prints and trims: pattern scale, placement print, stripes, logos, labels, buttons, drawstrings, zippers

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve garment silhouette, neckline, sleeve/leg length, seam paths, closure type, pocket count, hem shape, waistband, pleats, darts, layering, and how the item drapes on hanger, flat lay, or body.

### Material And Texture

Preserve fabric weight, weave/knit texture, denim grain, cotton softness, chiffon translucency, satin shine, leather/faux leather grain, fleece pile, lace holes, embroidery relief, and elastic ribbing.

### Marking, Label, And Physical Text Preservation

Preserve physical brand tags, woven labels, care tags, printed logos, embroidery, pattern text, and placement graphics. Do not invent slogans, size tags, or fashion typography.

### Scale And Context

Show realistic hanger, mannequin, model, flat-lay, body fit, sleeve length, waist fit, and textile thickness without changing size class or tailoring.

### Product Interaction And Use

Use scenes such as flat lay, hanger view, worn front/back, fabric stretch, pocket/zip detail, movement/drape, layering, styling, or washing/care detail when relevant.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing silhouette or fit
- inventing prints/logos
- changing fabric class
- removing seams/pockets/buttons
- turning a dress into a top
- changing sleeve or hem length
...
Frame 1: front garment hero.
Frame 2: back view.
Frame 3: worn fit view.
Frame 4: fabric texture close-up.
Frame 5: closure/detail frame.
Frame 6: movement/drape frame.
Frame 7: styling context.
Frame 8: label/care detail.
Frame 9: final fashion lifestyle scene.
...
The final prompt must make the image model preserve the real referenced fashion clothing product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.