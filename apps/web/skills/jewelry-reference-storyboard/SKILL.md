---
name: jewelry-reference-storyboard
description: Jewelry Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for rings, necklaces, pendants, earrings, bracelets, bangles, anklets, brooches, charms, beads, jewelry sets, jewelry boxes, and small ornamental accessories, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for เครื่องประดับ (rings, necklaces, pendants, earrings, bracelets, bangles, anklets, brooches, charms, beads, jewelry sets, jewelry boxes, and small ornamental accessories).
...
This skill writes high-fidelity image and storyboard prompts for เครื่องประดับ (rings, necklaces, pendants, earrings, bracelets, bangles, anklets, brooches, charms, beads, jewelry sets, jewelry boxes, and small ornamental accessories). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced jewelry product.
...
For เครื่องประดับ, the prompt must additionally preserve:
- rings: band profile, stone setting, prongs, engraving, shank shape, halo, stack set
- necklaces and bracelets: chain type, link shape, clasp, pendant bail, charm count, length
- earrings: stud, hoop, drop, hook, backer, pair symmetry, dangling movement
- materials: gold, rose gold, silver, platinum tone, enamel, pearl, resin, crystal, gemstone cut
- small details: facets, prongs, bezels, chain links, engraved text, texture, oxidation, plating color

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve metal color, band/chain thickness, gemstone count and cut, prong/setting type, pendant shape, clasp style, earring pair orientation, charm layout, and tiny component spacing.

### Material And Texture

Preserve polished metal reflection, brushed finish, hammered texture, pearl luster, gemstone transparency, crystal facets, enamel gloss, resin color depth, and oxidized grooves.

### Marking, Label, And Physical Text Preservation

Preserve engravings, hallmarks, brand tags, tiny stamped marks, pendant text, and packaging labels if visible; never invent karat marks or certification seals.

### Scale And Context

Show realistic finger, ear, neck, wrist, hand, jewelry tray, box, or macro scale; do not enlarge jewelry into decor or flatten dimensional settings.

### Product Interaction And Use

Use scenes such as macro hero, worn scale, clasp fastening, ring on hand, earring on ear, pendant close-up, box presentation, light sparkle, or set arrangement.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing gemstone cut/count
- changing metal color
- inventing luxury marks
- turning pendant into different symbol
- losing chain link structure
- over-smoothing tiny prongs/settings
...
Frame 1: macro product hero.
Frame 2: worn scale frame.
Frame 3: setting/facet close-up.
Frame 4: clasp/backer detail.
Frame 5: box/tray presentation.
Frame 6: material reflection frame.
Frame 7: pair/set layout.
Frame 8: engraving/hallmark detail.
Frame 9: final elegant lifestyle scene.
...
The final prompt must make the image model preserve the real referenced jewelry product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.