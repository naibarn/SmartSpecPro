---
name: pet-supplies-reference-storyboard
description: Pet Supplies Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for pet food, treats, bowls, collars, leashes, harnesses, beds, toys, litter items, grooming tools, carriers, cages, aquariums accessories, pet clothing, and animal-care products, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for ของใช้และอาหารสัตว์ (pet food, treats, bowls, collars, leashes, harnesses, beds, toys, litter items, grooming tools, carriers, cages, aquariums accessories, pet clothing, and animal-care products).
...
This skill writes high-fidelity image and storyboard prompts for ของใช้และอาหารสัตว์ (pet food, treats, bowls, collars, leashes, harnesses, beds, toys, litter items, grooming tools, carriers, cages, aquariums accessories, pet clothing, and animal-care products). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced pet supply or pet food product.
...
For ของใช้และอาหารสัตว์, the prompt must additionally preserve:
- food and treats: bag, pouch, can, tub, kibble shape, treat texture, flavor/colorway, feeding portion
- wear and walking: collar, leash, harness, buckle, clip, strap width, reflective strip
- comfort and habitat: pet bed, mat, carrier, crate, cage, litter box, scratching post, aquarium tool
- grooming and care: brush, comb, nail clipper, shampoo bottle, wipes, feeder, water fountain
- pet interaction: dog/cat/small pet scale, safe contact, chewing, feeding, resting, grooming

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve bowl shape, strap width, buckle/clip count, toy silhouette, bed cushion height, carrier door/vent pattern, food pack shape, kibble/treat geometry, and grooming tool teeth/bristle density.

### Material And Texture

Preserve nylon webbing, rubber chew texture, plush pile, stainless bowl shine, plastic carrier, rope fibers, ceramic glaze, cardboard/foil food pack, and kibble surface texture.

### Marking, Label, And Physical Text Preservation

Preserve pet food flavor/weight, collar tags, brand patches, printed pattern text, care labels, and package claims only if visible; never invent health claims or vet certifications.

### Scale And Context

Show realistic dog/cat/pet size relationship, hand scale, feeding area, crate, leash walk, grooming table, or home floor scale; avoid wrong animal-size assumptions.

### Product Interaction And Use

Use scenes such as feeding, wearing harness, toy play, bed rest, grooming, carrier use, treat texture close-up, package opening, or pet-safe home context.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- turning pet food into human food
- changing pet species scale
- inventing veterinary claims
- removing buckles/clips
- changing toy material
- making unsafe pet interaction
...
Frame 2: pet scale frame.
Frame 3: material/texture close-up.
Frame 4: functional detail.
Frame 5: safe pet interaction.
Frame 6: pack/label frame.
Frame 7: clean/storage frame.
Frame 8: use benefit scene.
Frame 9: final pet lifestyle frame.
...
The final prompt must make the image model preserve the real referenced pet supply or pet food product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.