---
name: electronics-reference-storyboard
description: Electronics Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for consumer electronic devices and accessories such as earbuds, headphones, speakers, routers, smart home devices, chargers, power banks, cables, adapters, hubs, microphones, lights, remotes, sensors, and compact gadgets, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for อุปกรณ์อิเล็กทรอนิกส์ (consumer electronic devices and accessories such as earbuds, headphones, speakers, routers, smart home devices, chargers, power banks, cables, adapters, hubs, microphones, lights, remotes, sensors, and compact gadgets).
...
This skill writes high-fidelity image and storyboard prompts for อุปกรณ์อิเล็กทรอนิกส์ (consumer electronic devices and accessories such as earbuds, headphones, speakers, routers, smart home devices, chargers, power banks, cables, adapters, hubs, microphones, lights, remotes, sensors, and compact gadgets). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced electronics product.
...
For อุปกรณ์อิเล็กทรอนิกส์, the prompt must additionally preserve:
- audio devices: earbuds, charging case, headphones, speaker grille, microphone mesh, remote
- power and connectivity: charger, cable connector, power bank, USB hub, adapter, router, modem
- smart devices: smart speaker, sensor, camera doorbell, controller, LED strip, remote
- device surfaces: buttons, ports, LED indicators, seams, rubber tips, grilles, magnets, clips
- accessory sets: case plus earbuds, cable plus adapter, hub plus laptop, speaker plus strap

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve device silhouette, port type and count, button layout, LED placement, grille pattern, cable connector shape, ear tip size, case hinge, strap/clip, seams, and accessory grouping.

### Material And Texture

Preserve matte or glossy plastic, anodized metal, rubber, silicone tips, fabric mesh, braided cable texture, translucent parts, LED glow, and glass/acrylic panels.

### Marking, Label, And Physical Text Preservation

Preserve physical model marks, port icons, tiny printed specs, certification marks only if visible, and brand logos; never invent screen UI, feature labels, or glowing text.

### Scale And Context

Show realistic hand, pocket, desk, wall outlet, bag, shelf, ear, or device-pairing scale; do not enlarge tiny gadgets into appliances or shrink speakers into earbuds.

### Product Interaction And Use

Use scenes such as charging, pairing, plugging in, wearing, desk setup, cable connection, speaker playback, smart-home placement, or port/detail close-ups.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- inventing ports or buttons
- turning earbuds into headphones
- changing connector type
- adding fake LED labels
- making generic black tech object
- changing case shape or grille layout
...
Frame 2: scale in hand.
Frame 3: port/button detail.
Frame 4: charging/pairing action.
Frame 5: material close-up.
Frame 6: use context.
Frame 7: accessory set layout.
Frame 8: LED/status detail.
Frame 9: final lifestyle tech setup.
...
The final prompt must make the image model preserve the real referenced electronics product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.