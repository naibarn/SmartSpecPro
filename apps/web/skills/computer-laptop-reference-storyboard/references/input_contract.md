...
Expected request payload for Computer And Laptop Reference Storyboard:

- `reference_product_images`: required product truth source for คอมพิวเตอร์และแล็ปท็อป.
