...
Expected request payload for Gaming And Accessories Reference Storyboard:

- `reference_product_images`: required product truth source for เกมส์และอุปกรณ์เสริม.
