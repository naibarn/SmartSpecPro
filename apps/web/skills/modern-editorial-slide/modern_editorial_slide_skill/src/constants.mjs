...
export const INTENT_TO_ARCHETYPES = {
  ...
  strategy_overview: ["executive_summary_dashboard", "two_column_editorial", "stat_card_with_image"],
  ...
  case_study: ["title_hero_split", "feature_story_panels", "two_column_editorial"]
};
