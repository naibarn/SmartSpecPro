---
name: food-beverage-reference-storyboard
description: Food And Beverage Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for packaged foods, fresh foods, snacks, ready meals, ingredients, sauces, condiments, powdered drinks, bottled/canned beverages, cups, pouches, cartons, multipacks, and serving presentations, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for อาหารและเครื่องดื่ม (packaged foods, fresh foods, snacks, ready meals, ingredients, sauces, condiments, powdered drinks, bottled/canned beverages, cups, pouches, cartons, multipacks, and serving presentations).
...
auto_trigger: false
triggerPatterns:
  - Food And Beverage Reference Storyboard
...
This skill writes high-fidelity image and storyboard prompts for อาหารและเครื่องดื่ม (packaged foods, fresh foods, snacks, ready meals, ingredients, sauces, condiments, powdered drinks, bottled/canned beverages, cups, pouches, cartons, multipacks, and serving presentations). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced food or beverage product.
...
For อาหารและเครื่องดื่ม, the prompt must additionally preserve:
- beverages: bottle, can, carton, pouch, cup, sachet, powder jar, tea/coffee pack
- snacks and dry food: bag, box, tray, wrapper, vacuum pack, jar, tin, multipack
- fresh and prepared food: fruit, bakery, frozen meal, ready-to-eat dish, meat/seafood pack
- condiments and ingredients: sauce bottle, spice jar, oil bottle, noodle pack, rice bag
- food surfaces: crumb, glaze, foam, bubbles, condensation, ice crystals, steam, sauce viscosity

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve package shape, cap/lid/seal, label panel, pouch gusset, can rim, bottle neck, carton fold, tray compartments, food cut shape, portion size, fill level, and serving form exactly from reference.

### Material And Texture

Preserve transparent plastic/glass, foil pouch crinkle, paper box, matte label, glossy wrapper, metal can, condensation, liquid clarity, foam, crumb texture, noodle strands, fruit skin, chocolate gloss, and frozen frost.

### Marking, Label, And Physical Text Preservation

Preserve brand, flavor name, nutrition/ingredient blocks, weight/volume, halal/organic/seal marks when physically present; never invent health claims, prices, ratings, or certifications.

### Scale And Context

Show realistic hand, plate, glass, fridge, shelf, table, pack, bowl, or serving scale. Do not make a small sachet look like a bottle or a drink bottle look like a cosmetics container.

### Product Interaction And Use

Use scenes such as pouring, opening, serving, biting, mixing, chilling, steaming, close-up texture, pack lineup, or table lifestyle while retaining packaging/food identity.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing flavor/colorway
- inventing labels or nutrition facts
- replacing the food texture with generic stock food
- changing bottle/can/carton geometry
- turning a package into cosmetics
- adding false claims
...
Frame 1: pack hero front.
Frame 2: ingredient/texture close-up.
Frame 3: open pack or cap.
Frame 4: pour/serve/use action.
Frame 5: portion scale.
Frame 6: freshness detail.
Frame 7: label verification frame.
Frame 8: consumption/lifestyle moment.
Frame 9: final appetizing product scene.
...
The final prompt must make the image model preserve the real referenced food or beverage product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.