...
CONTRACT)`. The profile is the authority for spoken language, market, register,
...
The story's narrative/content language is independent and follows the caller's
current UI/content-language contract. Do not change episode summaries,
character metadata, plot facts, or other narrative fields because the spoken
profile uses another language or dialect. Apply this profile only to dialogue,
dialogue-mirroring subtitles, and audio/TTS delivery.
