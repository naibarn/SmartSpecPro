---
name: sports-equipment-reference-storyboard
description: Sports Equipment Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for sports and fitness equipment such as balls, rackets, bats, clubs, gloves, helmets, pads, resistance bands, dumbbells, yoga gear, gym accessories, outdoor sports gear, protective equipment, and training tools, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for อุปกรณ์กีฬา (sports and fitness equipment such as balls, rackets, bats, clubs, gloves, helmets, pads, resistance bands, dumbbells, yoga gear, gym accessories, outdoor sports gear, protective equipment, and training tools).
...
This skill writes high-fidelity image and storyboard prompts for อุปกรณ์กีฬา (sports and fitness equipment such as balls, rackets, bats, clubs, gloves, helmets, pads, resistance bands, dumbbells, yoga gear, gym accessories, outdoor sports gear, protective equipment, and training tools). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced sports equipment product.
...
For อุปกรณ์กีฬา, the prompt must additionally preserve:
- ball sports: ball panel/seam pattern, valve, texture, inflation shape, size class
- rackets/bats/clubs: head shape, string pattern, grip wrap, shaft length, logo placement
- fitness: dumbbell plates, kettlebell handle, resistance band thickness, yoga mat edge, foam roller texture
- protective gear: helmet vents, padding, straps, shell shape, gloves, guards, braces
- outdoor/training: cones, nets, pumps, bottles, bags, straps, mounts, buckles

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve sport-specific geometry, ball seams, grip wrap, string density, plate count, strap/buckle layout, padding thickness, vent pattern, mat thickness, edge binding, and equipment size class.

### Material And Texture

Preserve rubber, leather, synthetic leather, foam, EVA, neoprene, woven strap, metal, carbon fiber, plastic shell, mesh, cork, and textured grip surfaces.

### Marking, Label, And Physical Text Preservation

Preserve brand marks, size/weight labels, ball panel graphics, racket strings/logo, certification marks only if visible, and printed measurement marks.

### Scale And Context

Show realistic hand, body, court, gym, field, bag, rack, or workout scale; do not make youth gear adult-size or small accessories full equipment.

### Product Interaction And Use

Use scenes such as grip/use action, training setup, protective fit, texture close-up, weight/size demonstration, storage in bag, court/field/gym context, or maintenance detail.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- changing sport category
- inventing logos/certifications
- changing ball panel pattern
- altering grip/string/strap layout
- changing material class
- unsafe use of protective gear
...
Frame 2: scale in hand/body.
Frame 3: sport-specific detail.
Frame 4: material/grip close-up.
Frame 5: use action.
Frame 6: fit/protection frame.
Frame 7: storage/kit context.
Frame 8: marking/size detail.
Frame 9: final active lifestyle scene.
...
The final prompt must make the image model preserve the real referenced sports equipment product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.