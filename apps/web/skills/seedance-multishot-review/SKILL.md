...
version: 1.0.0
description: Imported from Custom GPT (seedance_multishot_review.zip)
...
- seedance_multishot_review_skill/BLOCKED_TERMS.md
- seedance_multishot_review_skill/README.md
- seedance_multishot_review_skill/examples/strict-minimal-coffee-table-input.json
- seedance_multishot_review_skill/examples/strict-minimal-coffee-table-output.txt
- seedance_multishot_review_skill/schemas/input.schema.json
- seedance_multishot_review_skill/schemas/output.schema.json
- seedance_multishot_review_skill/schemas/ui.schema.json
- seedance_multishot_review_skill/skill.manifest.json