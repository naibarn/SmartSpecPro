---
name: automotive-reference-storyboard
description: Automotive Reference Storyboard prompt skill adapted from the furniture reference storyboard pattern. Optimized for automotive and motorcycle products such as vehicle accessories, interior accessories, exterior trims, tools, parts, lights, dash cameras, mounts, covers, fluids, care products, tires, helmets, and maintenance items, strict reference-image fidelity, exact product shape and proportion preservation, material and texture accuracy, marking/label preservation, product-source dominance, clean no-text-by-default image generation, infographic text controls, equal-frame storyboard layout, anti-generic-substitution guards, and category-specific QA gates. Use when generating image or storyboard prompts for ยานยนต์ (automotive and motorcycle products such as vehicle accessories, interior accessories, exterior trims, tools, parts, lights, dash cameras, mounts, covers, fluids, care products, tires, helmets, and maintenance items).
...
This skill writes high-fidelity image and storyboard prompts for ยานยนต์ (automotive and motorcycle products such as vehicle accessories, interior accessories, exterior trims, tools, parts, lights, dash cameras, mounts, covers, fluids, care products, tires, helmets, and maintenance items). It is adapted from the furniture reference storyboard skill's product-source-dominance, equal-frame storyboard, no-text-by-default, and QA-loop conventions, but all product fidelity rules are rewritten for this category.

The current product reference images are the highest-priority source of truth. Creative styling may change the environment, camera, lighting, props, and mood, but it MUST NOT redesign, resize, recolor, relabel, simplify, beautify, or replace the referenced automotive product.
...
For ยานยนต์, the prompt must additionally preserve:
- interior accessories: phone mount, organizer, mat, seat cover, cushion, dash cam, charger, sunshade
- exterior and parts: lights, trim, mirror, wiper, tire accessory, cover, license frame, guards
- tools and maintenance: pump, gauge, cleaner bottle, oil/fluid pack, brush, microfiber, repair kit
- motorcycle gear: helmet, gloves, grips, mirrors, mounts, bags, protective pads
- fitment details: mounting holes, clips, adhesive pads, connectors, sockets, harnesses, thread shape

## Category-Specific Physical Fidelity Rules

### Structure And Proportion

Preserve fitment geometry, mounting tabs, connector type, clip count, screw holes, cable routing, lens/reflector pattern, mat cutout, strap/buckle layout, bottle/nozzle shape, and vehicle-specific contour.

### Material And Texture

Preserve rubber, ABS plastic, carbon-fiber-look texture, leatherette, metal, chrome, glass lens, foam, microfiber, vinyl, silicone, reflective materials, and liquid bottle transparency.

### Marking, Label, And Physical Text Preservation

Preserve model/fitment labels, warning labels, printed sizes, molded logos, bottle text, lens markings, and physical certification marks only if visible; never invent compatibility claims.

### Scale And Context

Show realistic car/motorcycle/dashboard/seat/trunk/garage/hand scale. Do not imply fitment to a vehicle model unless supplied by user or visible reference.

### Product Interaction And Use

Use scenes such as installed position, before/after fit, connector close-up, hand scale, garage use, cleaning application, mounting action, driving context, or storage kit layout.

### Common Wrong Substitutions To Reject

The prompt must explicitly reject:
- inventing vehicle compatibility
- changing connector/mount shape
- turning small accessory into vehicle body part
- adding fake certification badges
- unsafe driving use
- removing mounting holes/clips
...
Frame 2: vehicle/hand scale.
Frame 3: mounting or fitment detail.
Frame 4: material/connector close-up.
Frame 5: install action.
Frame 6: installed context.
Frame 7: use benefit frame.
Frame 8: label/compatibility detail.
Frame 9: final automotive lifestyle scene.
...
The final prompt must make the image model preserve the real referenced automotive product: exact shape, proportions, material, texture, markings, and scale from the image, not a generic category archetype. It must also render the storyboard as cinematic, dimensional, photorealistic product-film imagery with clear, consistent human faces when character references are used.