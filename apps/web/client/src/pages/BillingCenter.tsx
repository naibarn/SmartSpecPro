                  ...
                  {selectedTopupInvoice ? (
                    <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-4">
                      ...
                      <div className="grid gap-3 text-sm text-slate-600 md:grid-cols-2">
                        ...
                        <div>
                          Payment method: {selectedTopupInvoice.activePayment?.providerPaymentType === "payment_link" ? "Card payment" : "PromptPay QR"}
                        </div>
                      ...
                      <div className="rounded-2xl border border-cyan-100 bg-cyan-50/70 p-4 text-sm text-slate-700">
                        {selectedTopupInvoice.activePayment?.providerPaymentType === "payment_link"
                      ...
                      {selectedTopupInvoice.activePayment?.status === "provider_pending_unknown" ? (
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {selectedTopupInvoice.activePayment?.paymentUrl ? (
                          <Button asChild>
                            <a href={String(selectedTopupInvoice.activePayment.paymentUrl)} target="_blank" rel="noreferrer">
                      ...
                      {selectedTopupInvoice.activePayment?.qrCodeUrl ? (
                        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                          ...
                          <div className="mt-4 flex justify-center rounded-2xl border border-slate-200 bg-white p-4">
                            <img
                              src={String(selectedTopupInvoice.activePayment.qrCodeUrl)}
                              alt="PromptPay QR"
