...
const TOOL_REGISTRY: McpToolDefinition[] = [
  {
    ...
    description: "List SmartSpecPro gateway models currently enabled for the owner",
  ...
  },
  {
    ...
    namespace: "gateway",
    toolGroup: "gateway_read",
    description: "Read the owner's current SmartSpecPro credit balance",
    requiredScope: "llm:chat",
    readWrite: "Read",
    delegatedWorkerEligible: true,
    executionMode: "implemented",
  ...
  },
  {
    ...
    description: "List SmartSpecPro skills visible to the current owner",
  ...
  },
  {
    ...
    namespace: "skills",
    toolGroup: "skills_read",
    description: "Inspect a specific SmartSpecPro skill before execution",
    requiredScope: "skills:list",
    readWrite: "Read",
    delegatedWorkerEligible: true,
    executionMode: "implemented",
  ...
  },
  {
    ...
    description: "Execute an allowed SmartSpecPro skill on behalf of the owner",
    requiredScope: "skills:execute",
    readWrite: "Write",
    delegatedWorkerEligible: true,
    executionMode: "implemented",
