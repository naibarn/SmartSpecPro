  ...
  return {
    ...
    info: {
      ...
      description: [
        ...
        "",
        "**Authentication**: All endpoints (except documentation) require a Bearer API key.",
        "Pass your key in the `Authorization: Bearer sk-ssp_...` header.",
        "",
        "**SDK generation**: Use `npx @openapitools/openapi-generator-cli generate",
        "-i https://smartaihub.app/v1/openapi.json -g typescript-fetch -o ./smartspec-sdk`",
        "to generate a TypeScript SDK from this spec.",
      ].join("\n"),
    },
    externalDocs: {
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          type: "http",
          scheme: "bearer",
          description: "API key in sk-ssp_ format. Generate via Admin → API Keys.",
        },
      },
