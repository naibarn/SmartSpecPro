  ...
  for (const recommendation of analysis.recommendations) {
    ...
    const baseValues = {
      ...
      recommendationJson: {
        ...
        upgradePriorityScore: analysis.upgradePriorityScore,
        upgradePriorityTier: analysis.upgradePriorityTier,
        parallelUpgradeEligible: analysis.parallelUpgradeEligible,
        legacyUpgradeSignals: analysis.legacyUpgradeSignals,
      },
      contractDeltaJson: {
