...
export const PROVIDER_TEMPLATES = [
  ...
  },
  {
    ...
    availableModels: [
      ...
      // Audio models
      { id: "fal-ai/gemini-3.1-flash-tts", name: "Gemini 3.1 Flash TTS", type: "audio" as const, description: "Single- and multi-speaker text-to-speech with language steering" },
