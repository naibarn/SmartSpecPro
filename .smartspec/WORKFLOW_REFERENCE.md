...
**Auto-Correction for Evidence Paths (v7.3.0)** ✅ **NEW**
- Automatically corrects naming convention violations
- 100% compliance guaranteed
- Saves 15-30 minutes per spec
- Integrated into workflows
- Tool: `auto_correct_evidence_paths.py`
- See: `WORKFLOW_IMPROVEMENT_IMPLEMENTED.md`
...
| **File names wrong** | Naming Issue | 4 | **Auto-Correct** ✅ | `auto_correct_evidence_paths.py tasks.md` | Automatic 100% compliance |
...
**Check Report:** Look for "similar_files" suggestions or "naming_issue" category

**Solution A: Auto-Correct Evidence Paths (v7.3.0)** ✅ **RECOMMENDED**

Automatically fix naming convention violations in tasks.md:

```bash
# Preview corrections
python3 .smartspec/scripts/auto_correct_evidence_paths.py tasks.md --dry-run
...
**Benefits:**
- ✅ Automatic correction (no manual editing)
- ✅ 100% naming compliance guaranteed
- ✅ Saves 15-30 minutes per spec
...
- After verification finds naming issues
- Before starting implementation

**Expected Result:** All paths follow naming convention, 100% compliance ✅

**Solution B: Rename Files** (Manual)
```bash
...
**Solution C: Update Evidence** (Manual)
```bash
